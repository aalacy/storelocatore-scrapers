...
(async () => {
    ...
    let url = 'https://www.shopnsavefood.com/DesktopModules/StoreLocator/API/StoreWebAPI.asmx/GetAllStores'
    ...
    let stores = await page.$$eval("#collapsible0 > div.expanded > div.collapsible-content > div.collapsible > div.expanded > div.collapsible-content", (elements)=>{
        let stores = []
        for( let e of elements ) {
            let fields = e.querySelectorAll('div > span:nth-child(2)');
            let store_obj = {
    ...
    browser.close();
    let csv = new ObjectsToCsv(stores);
