...
class ExampleSearchIteration(SearchIteration):
    def __init__(self, app_key, http):
...
if __name__ == "__main__":
    with SgRequests() as session:
        ...
        countries = get_countries(app_key, session)
        ...
        with SgWriter(
            ...
            par_search = ParallelDynamicSearch(
                ...
                search_iteration=lambda: ExampleSearchIteration(app_key=app_key, http=session),
