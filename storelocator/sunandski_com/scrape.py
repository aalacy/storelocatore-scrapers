...
def fetch_data():
    ...
    locator_domain = "https://www.sunandski.com"
    with SgRequests() as session:
        ...
        for store in store_list:
            ...
            hours = []
            for day, x in store["regularHours"].items():
                if day not in days:
                    break
                times = "closed"
                if not x["isClosed"]:
            ...
            if hours and "coming soon" in "; ".join(hours).lower():
                continue
            page_url = ""
            ...
            yield SgRecord(
                ...
                zip_postal=store["address"]["postalOrZipCode"],
