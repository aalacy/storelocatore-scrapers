...
def fetch_data():
    locator_domain = "https://mrsouvlaki.ca/"
    page_url = "https://mrsouvlaki.ca/find-us/"
    base_url = f"https://mrsouvlaki.ca/wp-content/plugins/superstorefinder-wp/ssf-wp-xml.php?wpml_lang=en&t={calendar.timegm(time.gmtime())}"
    with SgRequests() as session:
        ...
        for _ in locations:
            ...
            location_type = ""
            if re.search(r"temporarily closed", _.description.text, re.IGNORECASE):
