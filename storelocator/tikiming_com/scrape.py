...
def fetch_data():
    locator_domain = "http://tikiming.com/"
    page_url = "http://tikiming.com/locations/"
    base_url = f"http://tikiming.com/wp-content/plugins/superstorefinder-wp/ssf-wp-xml.php?wpml_lang=en&t={calendar.timegm(time.gmtime())}"
