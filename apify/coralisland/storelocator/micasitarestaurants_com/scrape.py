...
def fetch_data():
    output_list = []
    url = "https://www.micasitarestaurants.com/locations/"
    ...
    for store in store_list:
        ...
        store_hours = eliminate_space(etree.HTML(store['hours']).xpath('.//p/text()'))
        if 'closed' not in get_value(store_hours).lower():
