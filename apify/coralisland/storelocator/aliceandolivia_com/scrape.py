...
def fetch_data():
    ...
    stores = session.get(
        "https://www.aliceandolivia.com/on/demandware.store/Sites-aando-Site/default/Stores-FindStores?showMap=false&radius=300&postalCode=94107&radius=10000%20miles",
        headers=headers,
    ).json()["stores"]
    for store in stores:
        ...
        hours = " ".join(hours.split()) if hours else "<MISSING>"
