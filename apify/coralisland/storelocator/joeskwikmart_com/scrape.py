...
def fetch_data():
    output_list = []
    url = "https://joeskwikmart.com/locations?radius=-1&filter_catid=0&limit=0&filter_order=distance"
    ...
    for store in store_list:
        ...
        output.append(get_value(store['properties']['name']).replace('&apos;', "'")) #location name
        ...
        output.append("Joe's Kwik Mart") #location type
