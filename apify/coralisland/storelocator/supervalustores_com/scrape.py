...
base_url = 'http://supervalustores.com/'
...
def fetch_data():
    output_list = []
    url = "http://supervalustores.com/tools/cm?getAll=cities"
    page_url = 'http://supervalustores.com/'
    ...
    for store in store_list:
        ...
        output.append('Supervalu Store') #location type
        output.append(get_value(store['lat'])) #latitude
        output.append(get_value(store['lng'])) #longitude
        output.append(get_value(store['hours']).replace('<br />', ', ')) #opening hours
