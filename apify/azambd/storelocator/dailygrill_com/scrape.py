...
DOMAIN = "dailygrill.com"
website = "https://www.dailygrill.com"
location_type = "Restaurant"

log = sglog.SgLogSetup().get_logger(logger_name="dailygrill_com")
user_agent = (
...
def fetch_data():
    ...
    with SgChrome(user_agent=user_agent) as driver:
        ...
        res_id_nodes = data["CustomPageSection:123652"]["locations"]
