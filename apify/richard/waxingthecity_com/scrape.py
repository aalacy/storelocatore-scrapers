...
def fetch_data():
    ...
    store_url = driver.find_elements_by_css_selector('ul.nav.navbar-nav.navbar-right > li:nth-child(2) > a')[0].get_attribute('href')
    driver.get(store_url)

    # Fetch address/phone elements
    listings = [address.text for address in driver.find_elements_by_css_selector('div.col-xs-10')]
