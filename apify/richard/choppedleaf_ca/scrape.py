...
def fetch_data():
    ...
    location_url = driver.find_element_by_css_selector('li.menu-item.menu-item-type-post_type.menu-item-object-page.menu-item-1930 > a').get_attribute('href')
    driver.get(location_url)

    time.sleep(0.5)
    store_urls = [store_url.get_attribute('href') for store_url in driver.find_elements_by_css_selector('div.col-md-6 > div.google-map-result > a')]
    ...
    for store_url in store_urls:
        ...
        location_dict['locations_title'] = driver.find_element_by_css_selector('header > h1').text
        location_infos = [location_info.text for location_info in driver.find_elements_by_css_selector('div.row > div.col-sm-6 > div.well > ul.list-unstyled > li')]
        ...
        longitude, latitude, country, zip_code = parse_info(location_dict['street_address'], location_dict['city'], location_dict['state'])
        # Paste data
