    ...
    def fetch_data(self):
        ...
        for postal in self.postal_codes:
            for page in range(1, 11):
                ...
                if len(json.loads(driver.find_element_by_css_selector('body > pre').text)['items']) > 0:
                    stores.extend(json.loads(driver.find_element_by_css_selector('body > pre').text)['items'])
                else:
                    break
