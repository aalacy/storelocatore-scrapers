...
class Scraper(Scrape):
    ...
    def fetch_data(self):
        ...
        for store in stores:
            ...
            # Street
            street_address = store['profile']['address']['line1'] + ' ' + store['profile']['address']['line2'] if store['profile']['address']['line2'] else store['profile']['address']['line1']
