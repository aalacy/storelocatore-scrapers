...
def fetch_data():
    ...
    for listing in listings:
        ...
        # Address
        street_addresses.append((listing['address']['line1'] + ' ' + listing['address']['line2'] + ' ' + str(listing['address']['line3'])).strip())

        # City
        cities.append(listing['address']['city'].strip() if listing['address']['city'].strip() else '<MISSING>')
        ...
        # Phone
        phone_numbers.append(listing['phone'] if listing['phone'] != '' else '<MISSING>')
