...
class Scraper(Scrape):
    ...
    def fetch_data(self):
        ...
        for zip_search in sgzip.for_radius(200):
            location_url = f'https://www.shoeshowmega.com/on/demandware.store/Sites-shoe-show-Site/default/Stores-FindStores?showMap=true&radius=200&postalCode={zip_search}'
