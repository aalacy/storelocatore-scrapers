...
def fetch_data():
    ...
    store_url = driver.find_elements_by_css_selector('ul.menu.fl-menu-horizontal.fl-toggle-arrows > li:nth-child(3) > a')[0].get_attribute('href')
    ...
    # Get all listings
    listings = [address.text for address in driver.find_elements_by_css_selector('div.address-text-wrap')]
    ...
    for listing in listings:
        location_title, address, city, state, zip_code, phone, hour = parse_info(listing)
