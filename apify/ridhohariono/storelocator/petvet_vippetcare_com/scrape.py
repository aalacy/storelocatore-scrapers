...
DOMAIN = "petvet.vippetcare.com"
LOCATION_URL = "https://petvet.vippetcare.com/find-a-location/"
API_URL = "https://petvet.vippetcare.com/wp-json/clinic-locator/v1/search?&search={}&distance=100"
HEADERS = {
...
def fetch_data():
    ...
    for zip in search:
        ...
        for row in data["data"]:
            ...
            street_address = row["street"].strip().rstrip(",").rstrip(".")
            city = row["city"]
            state = row["state"]
            zip_postal = row["zip"]
