...
BASE_URL = "https://www.activerideshop.com"
LOCATION_URL = "https://www.activerideshop.com/pages/store-locator"
HEADERS = {
...
def fetch_data():
    ...
    contents = soup.find("div", {"class": "stores-list"}).find_all(
        "div", {"class": "col-md-2"}
    )
    for row in contents:
