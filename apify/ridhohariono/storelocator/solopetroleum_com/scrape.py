...
DOMAIN = "solopetroleum.com"
BASE_URL = "https://www.solopetroleum.com"
LOCATION_URL = "http://www.solopetroleum.com/site/partners.aspx"
HEADERS = {
...
def fetch_data():
    ...
    contents = soup.find("div", id="contentSub").find_all("p")
    for row in contents:
        info = (
