...
LOCATION_URL = "https://www.townpump.com/locations"
DATA_URL = "https://cdn.storelocatorwidgets.com/json/"
HEADERS = {
...
def fetch_data():
    ...
    uid = soup.find("script", id="storelocatorscript")["data-uid"]
    data = json.loads(
        session.get(DATA_URL + uid, headers=HEADERS)
        .text.replace("slw(", "")
        .replace("})", "}")
        .strip()
    )
