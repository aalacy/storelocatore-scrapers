...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.malbeccuisine.com/"
    session = SgRequests()
    headers = {
        "User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:90.0) Gecko/20100101 Firefox/90.0",
        "Accept": "*/*",
        "Accept-Language": "ru-RU,ru;q=0.8,en-US;q=0.5,en;q=0.3",
        "Referer": "https://www.malbeccuisine.com/",
        "Origin": "https://www.malbeccuisine.com",
    ...
    r = session.post(
        "https://www.malbeccuisine.com/graphql", headers=headers, json=json_data
    )
