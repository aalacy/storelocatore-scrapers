...
DOMAIN = "editionhotels.com"
URL_LOCATION = "https://www.marriott.com/hotel-search.mi"
logger = SgLogSetup().get_logger("editionhotels_com")
...
def get__regions_submit_search_urls():
    ...
    # it was decided to build the scrape for each brand, in this case, for Edition Hotels; that means,
    # This scrape returns the data for Edition Hotels accross the world. Above information are kept as a reference
    ...
    lis = [i + "&" + "marriottBrands=EB" for i in lis]
...
def scrape():
    ...
    with SgWriter(deduper=SgRecordDeduper(RecommendedRecordIds.PageUrlId)) as writer:
        results_7_brands = fetch_data_for_non_api_based_child_brands()
