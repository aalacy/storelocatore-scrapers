...
session = SgRequests()
DOMAIN = "https://www.pollotropical.com"
logger = SgLogSetup().get_logger(logger_name="pollotropical_com")
MISSING = "<MISSING>"
...
def get_all_stores_data():
    data_list = []
    url_location = "https://www.pollotropical.com/locations"
...
def fetch_data():
    ...
    location_name_menu = "https://olo.pollotropical.com/menu/"
    s = set()
    for row_num, data in enumerate(data_all):
        ...
        street_address = street_address.replace(
            "14150 SW 8th St, Miami FL", "14150 SW 8th St"
        )
