...
logger = SgLogSetup().get_logger("physiofit.urpt.com")
...
def fetch_data():
    locator_domain = "https://physiofit.urpt.com"
    base_url = (
        "https://physiofit.urpt.com/find-a-location/?state=LA&brand=&zip=&all-brands=0"
    )
