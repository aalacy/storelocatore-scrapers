...
logger = SgLogSetup().get_logger("beyondtherapykids.urpt.com")
...
def fetch_data():
    locator_domain = "https://beyondtherapykids.urpt.com"
    base_url = "https://beyondtherapykids.urpt.com/find-a-location/?state=MS&brand=&zip=&all-brands=0"
