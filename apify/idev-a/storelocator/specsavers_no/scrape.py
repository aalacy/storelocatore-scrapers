...
locator_domain = "https://www.specsavers.no"
base_url = "https://www.specsavers.no/finn-din-butikk/komplett-butikkoversikt"
    ...
    with SgChrome(
        ...
        with SgRequests() as session:
            ...
            for link in locations:
                page_url = "https://www.specsavers.no/finn-din-butikk/" + link["href"]
