...
base_url = "https://www.qatar.kfc.me/WebAPI/v2/Location/States?DeliveryMode=H"
locator_domain = "https://www.qatar.kfc.me"
...
def fetchConcurrentSingle(city):
    ...
    page_url = f"https://www.qatar.kfc.me/WebAPI/Location/Search?Channel=W&deliverymode=H&date={now}&city={city['CityId']}&filters=deliverymode-date-slot-city&Format=html&CurrentEvent=Location_Search"
...
def fetch_data():
    ...
    for state in states:
        area_url = f"https://www.qatar.kfc.me/WebAPI/v2/Location/State/{state['StateCode']}/Cities"
