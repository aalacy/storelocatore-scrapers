...
logger = SgLogSetup().get_logger("mahoganyprimesteakhouse")
...
def fetch_data():
    locator_domain = "https://mahoganyprimesteakhouse.com/"
    base_url = "https://mahoganyprimesteakhouse.com/locations/"
