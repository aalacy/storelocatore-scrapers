...
locator_domain = "https://oman.burgerking.me"
base_url = "https://oman.burgerking.me/en/locations.aspx"
...
def fetch_data():
    with SgRequests() as session:
        ...
        for _ in locations:
            ...
            addr = parse_address_intl(raw_address + ", Oman")
            ...
            yield SgRecord(
                ...
                street_address=street_address.replace("Oman", ""),
                city=city,
                state=addr.state,
