...
locator_domain = "https://www.specsavers.com.au"
base_url = "https://www.specsavers.com.au/stores/full-store-list"
days = [
    "Sunday",
    "Monday",
    "Tuesday",
    ...
    with SgChrome(
        ...
        with SgRequests() as session:
            ...
            for link in locations:
                page_url = "https://www.specsavers.com.au/stores/" + link["href"]
