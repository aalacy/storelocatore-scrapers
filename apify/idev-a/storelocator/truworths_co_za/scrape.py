...
locator_domain = "https://www.truworths.co.za"
base_url = "https://www.truworths.co.za/ccstore/v1/assembler/pages/Default/storeSearch?Ns=store.geocode({},{})&Nr=AND(product.active:1)&Nfg=store.geocode%7C{}%7C{}%7C500"
    ...
    for lat, lng in search:
        ...
        for loc in locations:
            ...
            if zip_postal == "0":
                zip_postal = ""
            yield SgRecord(
                page_url="https://www.truworths.co.za/store-location",
