...
logger = SgLogSetup().get_logger("nwsports.urpt.com")
...
def fetch_data():
    locator_domain = "https://nwsports.urpt.com"
    base_url = (
        "https://nwsports.urpt.com/find-a-location/?state=WA&brand=&zip=&all-brands=0"
    )
