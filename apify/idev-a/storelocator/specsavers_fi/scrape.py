...
locator_domain = "https://www.specsavers.fi"
base_url = "https://www.specsavers.fi/liikehaku/kaikki-liikkeemme"
    ...
    with SgChrome(
        ...
        with SgRequests() as session:
            ...
            for link in locations:
                page_url = "https://www.specsavers.fi/liikehaku/" + link["href"]
                ...
                hours = [
                    hh["content"] for hh in sp1.select("table.opening--day-and-time tr")
                ]
                phone = ""
