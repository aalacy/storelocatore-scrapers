...
base_url = "https://storerocket.io/api/user/DB8ebGWp9M/locations?radius=250&units=miles"
...
def fetch_data():
    with SgRequests() as session:
        ...
        for _ in locations:
            ...
            page_url = f"https://pon-bon.com/locations?location={_['slug']}"
            hours = []
            ...
            yield SgRecord(
                page_url=page_url,
                store_number=_["id"],
                location_name=_["name"].split("(")[0].strip(),
