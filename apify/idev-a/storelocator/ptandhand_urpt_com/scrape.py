...
logger = SgLogSetup().get_logger("ptandhand.urpt.com")
...
def fetch_data():
    locator_domain = "https://ptandhand.urpt.com/"
    base_url = (
        "https://ptandhand.urpt.com/find-a-location/?state=NC&brand=&zip=&all-brands=0"
    )
