...
base_url = "https://code.metalocator.com/index.php?option=com_locator&view=directory&force_link=1&tmpl=component&task=search_zip&framed=1&format=raw&no_html=1&templ[]=address_format&layout=_jsonfast&radius=25&interface_revision=453&user_lat=0&user_lng=0&Itemid=11595&preview=0&parent_table=&parent_id=0&search_type=point&_opt_out=&ml_location_override=&reset=true&nearest=false&national=true&callback=handleJSONPResults"
...
def fetch_data():
    with SgRequests() as session:
        locations = json.loads(
            ...
            .text.split("handleJSONPResults(")[1]
            .strip()[:-2]
        )["results"]
        for _ in locations:
            try:
                page_url = bs(_["html"], "lxml").select_one("a.collapse_list_reveal")[
                    "href"
                ]
            except:
                page_url = "https://btbautoparts.locationlandingpages.com"
