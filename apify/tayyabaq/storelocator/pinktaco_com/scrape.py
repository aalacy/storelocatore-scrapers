    ...
    for n in range(0,len(store_links)):
        if '\nCOMING SOON\n' not in store_text[n]:
            ...
            try:
                ...
                state.append(driver.find_element_by_xpath("//div[@class='details']/p[1]").text.split(",")[2].split()[0].strip())
                zipcode.append(driver.find_element_by_xpath("//div[@class='details']/p[1]").text.split(",")[2].split()[1].strip())
                ...
                state.append(driver.find_element_by_xpath("//div[@class='details']/p[2]").text.split(",")[1].split()[0].strip())
