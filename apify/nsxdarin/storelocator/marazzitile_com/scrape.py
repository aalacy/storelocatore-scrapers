...
def fetch_data():
    urls = ['https://www.marazziusa.com/where-to-buy/marazzi-showrooms,Showrooms','https://www.marazziusa.com/where-to-buy/premier-retailers,Premier Retailers','https://www.marazziusa.com/where-to-buy/wholesale-distributors,Wholesale Distributors']
    for url in urls:
        typ = url.split(',')[1]
