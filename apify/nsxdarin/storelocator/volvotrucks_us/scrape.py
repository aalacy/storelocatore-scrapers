...
def fetch_data():
    url = "https://www.volvotrucks.us/simpleprox.ashx?http://mvservices.na.volvogroup.com/Volvo_DealerJSON.ashx?state=1"
            ...
            for item in items:
                if "MAIN_ADDRESS_LINE_1_TXT" in item:
                    ...
                    add = (
                        add
                        + " "
                        + item.split(',"MAIN_ADDRESS_LINE_2_TXT":"')[1].split('"')[0]
                    )
                    add = add.strip()
