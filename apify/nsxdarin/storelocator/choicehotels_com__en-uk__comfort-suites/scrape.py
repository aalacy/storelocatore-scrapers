...
logger = SgLogSetup().get_logger("choicehotels_com__en-uk__comfort-suites")
...
def fetch_data():
    ...
    website = "choicehotels.com/en-uk/comfort-suites"
    country = "GB"
    typ = "Comfort Suites"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "united-kingdom" in line and "comfort-suites-hotels/gb" in line:
            locs.append(
    ...
    for loc in locs:
        ...
        state = ""
        zc = ""
        store = loc.split("comfort-suites-hotels/")[1]
        phone = ""
        lat = ""
        lng = ""
        hours = "<MISSING>"
