...
def fetch_data():
    ...
    for url in urls:
        ...
        for item in json.loads(r.content)['searchResults']:
            ...
            hours = 'Sun: ' + str(item['fields']['SUN_OPEN']) + '-' + str(item['fields']['SUN_CLOSE'])
            hours = hours + '; Mon: ' + str(item['fields']['MON_OPEN']) + '-' + str(item['fields']['MON_CLOSE'])
            hours = hours + '; Tue: ' + str(item['fields']['TUES_OPEN']) + '-' + str(item['fields']['TUES_CLOSE'])
            hours = hours + '; Wed: ' + str(item['fields']['WED_OPEN']) + '-' + str(item['fields']['WED_CLOSE'])
            hours = hours + '; Thu: ' + str(item['fields']['THURS_OPEN']) + '-' + str(item['fields']['THURS_CLOSE'])
            hours = hours + '; Fri: ' + str(item['fields']['FRI_OPEN']) + '-' + str(item['fields']['FRI_CLOSE'])
            hours = hours + '; Sat: ' + str(item['fields']['SAT_OPEN']) + '-' + str(item['fields']['SAT_CLOSE'])
            yield SgRecord(
