    ...
    for loc in locs:
        ...
        for line2 in r2.iter_lines():
            ...
            if '"storeName":"' in line2:
                ...
                hours = 'Sun: ' + days[1].split('"open":"')[1].split('"')[0] + '-' + days[1].split('"close":"')[1].split('"')[0]
                hours = hours + '; Mon: ' + days[2].split('"open":"')[1].split('"')[0] + '-' + days[2].split('"close":"')[1].split('"')[0]
                hours = hours + '; Tue: ' + days[3].split('"open":"')[1].split('"')[0] + '-' + days[3].split('"close":"')[1].split('"')[0]
                hours = hours + '; Wed: ' + days[4].split('"open":"')[1].split('"')[0] + '-' + days[4].split('"close":"')[1].split('"')[0]
                hours = hours + '; Thu: ' + days[5].split('"open":"')[1].split('"')[0] + '-' + days[5].split('"close":"')[1].split('"')[0]
                hours = hours + '; Fri: ' + days[6].split('"open":"')[1].split('"')[0] + '-' + days[6].split('"close":"')[1].split('"')[0]
                hours = hours + '; Sat: ' + days[7].split('"open":"')[1].split('"')[0] + '-' + days[7].split('"close":"')[1].split('"')[0]
        yield [
            website,
            loc,
            name,
