...
def fetch_stores(code):
    with SgRequests() as http:
        ...
        url = f"https://www.walmart.ca/en/stores-near-me/api/searchStores?singleLineAddr={formatted_code}&serviceTypes=WALMART_PHOTO_CENTRE"
        return http.get(url, headers=headers).json()["payload"]["stores"]


def fetch_data():
    website = "walmart.ca/?fltr_equals_WALMART_PHOTO_CENTRE"
    typ = "Walmart"
    country = "CA"
