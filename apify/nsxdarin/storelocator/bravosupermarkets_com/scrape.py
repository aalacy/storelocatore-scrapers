...
logger = SgLogSetup().get_logger("bravosupermarkets_com")
...
def fetch_data():
    locs = []
    url = "https://locations.bravosupermarkets.com/sitemap.xml"
    r = session.get(url, headers=headers)
    website = "bravosupermarkets.com"
    typ = "<MISSING>"
    country = "US"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "https://locations.bravosupermarkets.com/bravo-supermarkets-" in line:
