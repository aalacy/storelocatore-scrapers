...
def fetch_data():
    locs = ['https://www.ihg.com/intercontinental/hotels/us/en/bangkok/bkkhb/hoteldetail',
            ...
            try:
                ...
                for line2 in r2.iter_lines():
                    ...
                    if 'property="og:title" content="' in line2 and name == "":
                        name = line2.split('property="og:title" content="')[1].split(
                            '"'
                        )[0]
                    ...
                    if '<span itemprop="streetAddress">' in line2 and add == "":
                        ...
                        try:
                            ...
                            state = "<MISSING>"
                        try:
                            zc = line2.split('<span itemprop="zipCode">')[1].split("<")[
                                0
                            ]
                        except:
                            zc = "<MISSING>"
                    ...
                    if 'itemprop="addressRegion">' in line2:
                        state2 = line2.split('itemprop="addressRegion">')[1].split("<")[
                            0
                        ]
                    if 'itemprop="addressLocality">' in line2:
                        city2 = line2.split('itemprop="addressLocality">')[1].split(
                            "<"
                        )[0]
                    if 'itemprop="postalCode">' in line2:
                        zc2 = line2.split('itemprop="postalCode">')[1].split("<")[0]
                    if '<meta itemprop="latitude" content="' in line2:
                        lat2 = line2.split('<meta itemprop="latitude" content="')[
                            1
                        ].split('"')[0]
                    if '<meta itemprop="longitude" content="' in line2:
                        lng2 = line2.split('<meta itemprop="longitude" content="')[
                            1
                        ].split('"')[0]
                ...
                city = city.replace("&#39;", "'")
                add = (
                    add.replace("&#39;", "'").replace("&amp;", "&").replace("amp;", "&")
                )
