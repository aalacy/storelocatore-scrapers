...
def fetch_data():
    ...
    while code:
        url = 'https://www.cadillacoffers.ca/apps/leap/readDealersJson?searchType=postalCodeSearch&postalCode=' + code.replace(' ','%20') + '&language=en&pagePath=%2Fcontent%2Fcadillac-offers%2Fca%2Fen%2Fdealer-locations&_=1604593530983'
        logger.info('Pulling Code %s...' % code)
