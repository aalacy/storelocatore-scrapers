...
logger = SgLogSetup().get_logger("choicehotels_com__en-uk__suburban")
...
def fetch_data():
    ...
    website = "choicehotels.com/en-uk/suburban"
    country = "GB"
    typ = "Suburban"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "united-kingdom" in line and "suburban-hotels/gb" in line:
            locs.append(
    ...
    for loc in locs:
        ...
        state = ""
        zc = ""
        store = loc.split("suburban-hotels/")[1]
        phone = ""
        lat = ""
        lng = ""
        hours = "<MISSING>"
