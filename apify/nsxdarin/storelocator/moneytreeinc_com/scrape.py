...
logger = SgLogSetup().get_logger("moneytreeinc_com")
...
def fetch_data():
    locs = []
    url = "https://locations.moneytreeinc.com/sitemap.xml"
    r = session.get(url, headers=headers)
    website = "moneytreeinc.com"
    typ = "<MISSING>"
    country = "US"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "<loc>https://locations.moneytreeinc.com/moneytree-" in line:
