...
logger = SgLogSetup().get_logger("choicehotels_com__en-uk__econo-lodge")
...
def fetch_data():
    ...
    website = "choicehotels.com/en-uk/econo-lodge"
    country = "GB"
    typ = "Econo Lodge"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "united-kingdom" in line and "econo-lodge-hotels/gb" in line:
            locs.append(
    ...
    for loc in locs:
        ...
        state = ""
        zc = ""
        store = loc.split("econo-lodge-hotels/")[1]
        phone = ""
        lat = ""
        lng = ""
        hours = "<MISSING>"
