            ...
            if '"_geoloc":' in line:
                ...
                for item in items:
                    if ',"status":"' in item:
                        website = "nike.com"
                        typ = (
                            item.split('"parkingSuggestions"')[1]
                            .split('"type":"')[1]
                            .split('"')[0]
                        )
                        ...
                        try:
                            ...
                            zc = "<MISSING>"
                        purl = (
                            "https://www.nike.com/us/retail/s/"
                        ...
                        for day in days:
                            if '"startTime":"' in day:
                                hrs = (
                                    day.split('"displayDay":"')[1].split('"')[0]
                                    + ": "
                                    + day.split(',"displayStartTime":"')[1]
                                    .split('"')[0]
                                    .strip()
                                    + "-"
                                    + day.split(',"displayEndTime":"')[1]
                                    .split('"')[0]
                                    .strip()
                                )
                                if hours == "":
