...
def fetch_data():
    ...
    loc = "https://sheets.googleapis.com/v4/spreadsheets/190IEJyPRC8nN5LYpYmuKDee52fKSlMDtMlh2UbrDEM8/values/1Stores?key=AIzaSyCWzsoRvbqZ_ilWyJ2z88O4nps4oGU5idU"
    headers = {
    ...
    for item in json.loads(r2.content)["values"]:
        if item[0] != "storeNumber" and item[0] != "":
            ...
            purl = (
                "https://www.elephantcastle.com/en/locations/"
                + store
                + "/"
                + city.lower()
                + "-"
