...
logger = SgLogSetup().get_logger("rue21_com")
    ...
    for loc in locs:
        ...
        for line2 in r2.iter_lines(decode_unicode=True):
            if name == "" and '<span class="location-geomodifier">' in line2:
                name = line2.split('<span class="location-geomodifier">')[1].split("<")[
                    0
                ]
            if add == "" and '<span class="c-address-street-1">' in line2:
                ...
                if (
                    ...
                    in line2.split('<span class="c-address-street-1">')[1].split(
                    ...
                    add = (
                        add
                        + " "
                        + line2.split('<span class="c-address-street-2">')[1]
                        .split("<")[0]
                        .strip()
                    )
                city = (
            ...
            if '<div class="coming-soon">Coming Soon</div>' in line2:
                CS = True
        if hours == "":
            hours = "<MISSING>"
        if phone == "":
