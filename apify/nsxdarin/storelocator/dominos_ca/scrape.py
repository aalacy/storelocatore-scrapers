        ...
        if "/--/" not in loc:
            ...
            for line2 in lines:
                ...
                if 'id="Street" name="Street" value="' in line2:
                    add = line2.split('id="Street" name="Street" value="')[1].split(
                        '"'
                    )[0]
                ...
                if 'id="Region" name="Region" value="' in line2:
                    state = line2.split('id="Region" name="Region" value="')[1].split(
                        '"'
                    )[0]
                if 'id="PostalCode" name="PostalCode" value="' in line2:
                    zc = line2.split('id="PostalCode" name="PostalCode" value="')[
                        1
                    ].split('"')[0]
