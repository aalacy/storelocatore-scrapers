...
def fetch_data():
    alllocs = []
    urls = ['https://www.ihg.com/candlewood/destinations/us/en/canada-hotels','https://www.ihg.com/candlewood/destinations/us/en/united-states-hotels']
    for url in urls:
        states = []
        ...
        for state in states:
            ...
            for city in cities:
                ...
                for line3 in r3.iter_lines(decode_unicode=True):
                    if 'https://www.ihg.com/candlewood/hotels/' in line3 and '{"@context":"https://www.schema.org"' in line3:
