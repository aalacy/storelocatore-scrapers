...
logger = SgLogSetup().get_logger("choicehotels_com__en-uk__cambria")
...
def fetch_data():
    ...
    website = "choicehotels.com/en-uk/cambria"
    country = "GB"
    typ = "Cambria"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "united-kingdom" in line and "cambria-hotels/gb" in line:
            locs.append(
    ...
    for loc in locs:
        ...
        state = ""
        zc = ""
        store = loc.split("cambria-hotels/")[1]
        phone = ""
        lat = ""
        lng = ""
        hours = "<MISSING>"
