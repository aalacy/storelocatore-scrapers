...
logger = SgLogSetup().get_logger("choicehotels_com__en-uk__clarion")
...
def fetch_data():
    ...
    website = "choicehotels.com/en-uk/clarion"
    country = "GB"
    typ = "Clarion"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "united-kingdom" in line and "clarion-hotels/gb" in line:
            locs.append(
    ...
    for loc in locs:
        ...
        state = ""
        zc = ""
        store = loc.split("clarion-hotels/")[1]
        phone = ""
        lat = ""
        lng = ""
        hours = "<MISSING>"
