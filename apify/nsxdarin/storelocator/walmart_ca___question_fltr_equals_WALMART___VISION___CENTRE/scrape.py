...
logger = SgLogSetup().get_logger("walmart_ca__?fltr_equals_WALMART___VISION___CENTRE")
...
def fetch_data():
    ...
    for code in search:
        ...
        website = "walmart.ca/?fltr_equals_WALMART___VISION___CENTRE"
        typ = "Walmart"
        session = SgRequests()
        ...
        for line2 in r2.iter_lines(decode_unicode=True):
            if '"stores":[{"distance":' in line2:
                ...
                for item in items:
                    if '"address":{' in item and "WALMART_VISION_CENTRE" in str(item):
                        hours = ""
