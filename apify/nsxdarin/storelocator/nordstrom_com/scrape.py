...
def write_output(data):
    with open('data.csv', mode='w') as output_file:
        ...
        writer.writerow(["locator_domain", "page_ur", "location_name", "street_address", "city", "state", "zip", "country_code", "store_number", "phone", "location_type", "latitude", "longitude", "hours_of_operation"])
        for row in data:
            writer.writerow(row)
