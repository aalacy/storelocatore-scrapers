...
def fetch_data():
    ...
    for item in json.loads(r.content)['result']:
        ...
        name = "Popeye's"
        try:
            hours = 'Mon: ' + item['deliveryHours']['monOpen'].replace('1970-01-01 ','').rsplit(':',1)[0] + '-' + item['deliveryHours']['monClose'].replace('1970-01-01 ','').rsplit(':',1)[0]
            hours = hours + '; Tue: ' + item['deliveryHours']['tueOpen'].replace('1970-01-01 ','').rsplit(':',1)[0] + '-' + item['deliveryHours']['tueClose'].replace('1970-01-01 ','').rsplit(':',1)[0]
            hours = hours + '; Wed: ' + item['deliveryHours']['wedOpen'].replace('1970-01-01 ','').rsplit(':',1)[0] + '-' + item['deliveryHours']['wedClose'].replace('1970-01-01 ','').rsplit(':',1)[0]
            hours = hours + '; Thu: ' + item['deliveryHours']['thrOpen'].replace('1970-01-01 ','').rsplit(':',1)[0] + '-' + item['deliveryHours']['thrClose'].replace('1970-01-01 ','').rsplit(':',1)[0]
            hours = hours + '; Fri: ' + item['deliveryHours']['friOpen'].replace('1970-01-01 ','').rsplit(':',1)[0] + '-' + item['deliveryHours']['friClose'].replace('1970-01-01 ','').rsplit(':',1)[0]
            hours = hours + '; Sat: ' + item['deliveryHours']['satOpen'].replace('1970-01-01 ','').rsplit(':',1)[0] + '-' + item['deliveryHours']['satClose'].replace('1970-01-01 ','').rsplit(':',1)[0]
            hours = hours + '; Sun: ' + item['deliveryHours']['sunOpen'].replace('1970-01-01 ','').rsplit(':',1)[0] + '-' + item['deliveryHours']['sunClose'].replace('1970-01-01 ','').rsplit(':',1)[0]
        except:
            pass
        if phone == '':
            phone = '<MISSING>'
