...
def fetch_data():
    url = "https://www.prohealthcare.com/bin/optumcare/findlocations?businessName=&fullName=&search=10001&latitude=40.75368539999999&longitude=-73.9991637&radius=25mi&network=ProHEALTHCare&isAcceptingNewPatients=true"
        ...
        if '"individualProviderId":"' in line:
            ...
            for item in items:
                if "providerRole" in item:
                    ...
                    try:
                        phone = (
                            item.split('"telephoneNumbers":[{"telephoneNumber":"')[1]
                            .split('"')[0]
                            .replace("+1 ", "")
                        )
                    except:
