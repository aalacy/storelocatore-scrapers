...
logger = SgLogSetup().get_logger("choicehotels_com__en-uk__rodeway-inn")
...
def fetch_data():
    ...
    website = "choicehotels.com/en-uk/rodeway-inn"
    country = "GB"
    typ = "Rodeway Inn"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "united-kingdom" in line and "rodeway-inn-hotels/gb" in line:
            locs.append(
    ...
    for loc in locs:
        ...
        state = ""
        zc = ""
        store = loc.split("rodeway-inn-hotels/")[1]
        phone = ""
        lat = ""
        lng = ""
        hours = "<MISSING>"
