                ...
                if purl not in ids:
                    ...
                    for line2 in r2.iter_lines():
                        if '<meta name="geo.position" content="' in line2:
                            lat = line2.split('<meta name="geo.position" content="')[
                                1
                            ].split(";")[0]
                            lng = (
                        ...
                        if '"geo.placename" content="' in line2:
                            name = line2.split('"geo.placename" content="')[1].split(
                                '"'
                            )[0]
                        if 'margin:0;">  <li> <img alt="' in line2:
                            typ = line2.split('margin:0;">  <li> <img alt="')[1].split(
                                " in "
                            )[0]
                        if '<span itemprop="streetAddress">' in line2:
                            ...
                            city = line2.split('itemprop="addressLocality">')[1].split(
                                "<"
                            )[0]
