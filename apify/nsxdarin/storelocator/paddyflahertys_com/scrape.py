...
logger = SgLogSetup().get_logger("paddyflahertys_com")
...
def fetch_data():
    locs = []
    url = "https://www.paddyflahertys.com/en/locations.html"
    r = session.get(url, headers=headers)
    website = "paddyflahertys.com"
    typ = "<MISSING>"
    ids = []
    country = "CA"
            ...
            if '"type":"text","$t":"storename:' in line2:
                ...
                for item in items:
                    if "latitude:" in item:
                        ...
                        purl = (
                            "https://www.paddyflahertys.com/en/locations/"
                            + store
                            + "/"
