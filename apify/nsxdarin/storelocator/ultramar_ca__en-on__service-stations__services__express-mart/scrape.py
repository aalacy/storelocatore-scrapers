...
def fetch_data():
    ...
    for item in canada:
        lat = item.split(',')[0]
        lng = item.split(',')[1]
        url = 'https://www.ultramar.ca/en-on/find-services-stations/?latitude=' + lat + '&longitude=' + lng + '&is_depanneur=on'
            ...
            if 'data-lat="' in line:
                ...
                for item in items:
                    if 'data-lng="' in item:
                        ...
                        lng = ''
                        country = 'CA'
                        website = 'ultramar.ca/en-on/service-stations/services/express-mart'
