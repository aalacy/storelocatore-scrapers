...
logger = SgLogSetup().get_logger("gpminvestments_com__scotchman")
...
def fetch_data():
    ...
    website = "gpminvestments.com/scotchman"
    typ = "<MISSING>"
    country = "US"
    loc = "<MISSING>"
    hours = "<MISSING>"
                ...
                if '"title":"' in item:
                    ...
                    if (
                        ...
                        try:
                            ...
                            try:
                                address = (
                                    add[0]["AddressNumber"] + " " + add[0]["StreetName"] + " " + add[0]["StreetNamePostType"]
                                )
                            except:
                                add = "<INACCESSIBLE>"
                            if add == "":
