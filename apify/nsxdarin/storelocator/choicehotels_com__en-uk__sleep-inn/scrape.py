...
logger = SgLogSetup().get_logger("choicehotels_com__en-uk__sleep-inn")
...
def fetch_data():
    ...
    website = "choicehotels.com/en-uk/sleep-inn"
    country = "GB"
    typ = "Sleep Inn"
    logger.info("Pulling Stores")
    for line in r.iter_lines():
        line = str(line.decode("utf-8"))
        if "united-kingdom" in line and "sleep-inn-hotels/gb" in line:
            locs.append(
    ...
    for loc in locs:
        ...
        state = ""
        zc = ""
        store = loc.split("sleep-inn-hotels/")[1]
        phone = ""
        lat = ""
        lng = ""
        hours = "<MISSING>"
