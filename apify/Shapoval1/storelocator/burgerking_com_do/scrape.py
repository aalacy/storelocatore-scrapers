...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "http://www.burgerking.com.do/"
    for i in range(0, 100):
        page_url = f"http://www.burgerking.com.do/locations?field_geofield_distance%5Borigin%5D%5Blat%5D=18.510436&field_geofield_distance%5Borigin%5D%5Blon%5D=-69.84042&page={i}&target=Santo%20Domingo"
        session = SgRequests()
        headers = {
