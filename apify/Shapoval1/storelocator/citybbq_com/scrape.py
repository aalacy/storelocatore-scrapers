...
def get_data(coords, sgw: SgWriter):
    ...
    api_url = f"https://nomnom-prod-api.citybbq.com/restaurants/near?lat={str(lat)}&long={str(long)}&radius=20000&limit=100&nomnom=calendars&nomnom_calendars_from=20210822&nomnom_calendars_to=20220219&nomnom_exclude_extref=999"
    ...
    api_url = "https://nomnom-prod-api.citybbq.com/restaurants/near?lat=13.49&long=144.78&radius=20&limit=6&nomnom=calendars&nomnom_calendars_from=20210822&nomnom_calendars_to=20220219&nomnom_exclude_extref=999"
