...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.brunosafeparking.be/"
    api_url = "https://www.brunosafeparking.be/nl/location/ajax?filter%5B%5D=6"
    session = SgRequests()
    headers = {
    ...
    for d in div:
        ...
        page_url = f"https://www.brunosafeparking.be{slug}"
        ...
        r = session.get(
            f"https://www.brunosafeparking.be/nl/api/locations/{store_number}"
        )
        js = r.json()
        latitude = js[0][1]
        longitude = js[0][2]
