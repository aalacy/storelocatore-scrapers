...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "http://ippudo.com.au"
    page_url = "http://ippudo.com.au/store/"
    headers = {
    ...
    for d in div:
        ...
        ad = (
            " ".join(d.xpath('.//th[text()="Address"]/following-sibling::td/text()'))
            .replace("\n", "")
            .strip()
        )
        ...
        hours = d.xpath('.//th[text()="Opening Hours"]/following-sibling::td/text()')
        tmp = []
        for h in hours:
            if "pm" in h:
                tmp.append(h)
