...
def fetch_data(sgw: SgWriter):
    ...
    for j in js:
        ...
        day_3 = tree.xpath(
            '//h4[text()="Opening Hours"]/following-sibling::table//tr[./td][3]//text()'
        )
        ...
        day_4 = tree.xpath(
            '//h4[text()="Opening Hours"]/following-sibling::table//tr[./td][4]//text()'
        )
        ...
        day_5 = tree.xpath(
            '//h4[text()="Opening Hours"]/following-sibling::table//tr[./td][5]//text()'
        )
        ...
        day_6 = tree.xpath(
            '//h4[text()="Opening Hours"]/following-sibling::table//tr[./td][6]//text()'
        )
        ...
        day_7 = tree.xpath(
            '//h4[text()="Opening Hours"]/following-sibling::table//tr[./td][7]//text()'
        )
        ...
        hours_of_operation = (
            hours_of_operation.replace("Monday;", "")
            .replace("Wednesday;", "")
            .replace("Tuesday;", "")
            .strip()
        )
