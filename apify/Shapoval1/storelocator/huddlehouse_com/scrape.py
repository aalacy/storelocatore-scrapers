...
def generate_links():
    session = SgRequests()
    r = session.get("https://locations.huddlehouse.com/index.json")
...
def get_urls(states):
    for state in states.values():
        ...
        if children is None:
            yield f"https://locations.huddlehouse.com/{state['url']}.json"
        else:
...
def get_data(url):
    ...
    locator_domain = "https://www.huddlehouse.com/"
