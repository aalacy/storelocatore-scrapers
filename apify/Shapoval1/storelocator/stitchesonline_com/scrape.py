...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://stitchesonline.com/"
    api_url = "https://urban-planet.com/apps/api/v1/stores?location[latitude]=49.8816557&location[longitude]=-97.19511179999999&location[radius]=10000&location[units]=km&brands[]=Stitches"
    session = SgRequests()
    headers = {
