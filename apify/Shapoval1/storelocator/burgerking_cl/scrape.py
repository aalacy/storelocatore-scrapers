...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "http://www.burgerking.cl/"
    for i in range(0, 100):
        page_url = f"http://www.burgerking.cl/locations?field_geofield_distance%5Borigin%5D%5Blat%5D=-33.448822&field_geofield_distance%5Borigin%5D%5Blon%5D=-70.66928&page={i}&target=Estacion%20Central"
        session = SgRequests()
        headers = {
