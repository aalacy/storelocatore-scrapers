...
def fetch_data():
    ...
    data = {
        "method": "POST",
        "apiurl": "https://prengerfoods.rsaamerica.com/Services/SSWebRestApi.svc/GetClientStores/1",
    }
    r = session.post(
        "https://prengerfoods.com/ajax/index.php", headers=headers, data=data
    )
    js = r.json()
    for j in js["GetClientStores"]:

        page_url = "https://prengerfoods.com/contact"
