...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://kevinjewelers.com/"
    api_url = "https://kevinjewelers.com/tools/store-locator"
    session = SgRequests()
    headers = {
    ...
    for d in div:
        ...
        page_url = "https://kevinjewelers.com/tools/store-locator"
        location_name = (
        ...
        phone = (
            ...
            .replace("TEXT or Call", "")
            .strip()
            or "<MISSING>"
        )
        hours_of_operation = (
            " ".join(d.xpath('.//span[@class="phone"]/following-sibling::span/text()'))
            .replace("\r\n", "")
            .replace("Hours", "")
            .replace("Open", "")
            .strip()
