...
def fetch_data():
    ...
    locator_domain = "https://shopmyluckys.com"
    api_url = "https://shopmyluckys.com/ajax/index.php"
    session = SgRequests()
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Gecko/20100101 Firefox/88.0",
        "Referer": "https://shopmyluckys.com/contact",
    }

    data = {
        "method": "POST",
        "apiurl": "https://shopmyluckys.rsaamerica.com/Services/SSWebRestApi.svc/GetClientStores/1",
    }
    ...
    for j in js["GetClientStores"]:
        ...
        page_url = "https://shopmyluckys.com/contact"
