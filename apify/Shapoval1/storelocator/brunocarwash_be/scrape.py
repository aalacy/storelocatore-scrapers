...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://brunocarwash.be/"
    api_url = "https://www.brunocarwash.be/nl/location/ajax?filter%5B%5D=4"
    session = SgRequests()
    headers = {
    ...
    for d in div:
        ...
        r = session.get(f"https://www.brunocarwash.be/nl/api/locations/{store_number}")
        js = r.json()
        latitude = js[0][1]
        longitude = js[0][2]
