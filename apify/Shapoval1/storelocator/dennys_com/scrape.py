...
def fetch_data(sgw: SgWriter):
    locator_domain = "https://www.dennys.com/"
    api_url = "https://dennys.olo.com/api/vendors/regions?excludeCities=true"
    session = SgRequests()
    headers = {
        ...
        "Referer": "https://dennys.olo.com/locations",
    ...
    for j in js:
        ...
        session = SgRequests()
        r = session.get(
            f"https://dennys.olo.com/api/vendors/search/{code}", headers=headers
        )
        js = r.json()["vendor-search-results"]
        for j in js:
            page_url = f"https://dennys.olo.com/menu/{j.get('slug')}"
