...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://kaufland.de/"
    api_url = "https://filiale.kaufland.de/.klstorefinder.json"
    headers = {
    ...
    for j in js:
        ...
        page_url = (
            f"https://filiale.kaufland.de/service/filiale.storeName={store_number}.html"
        )
