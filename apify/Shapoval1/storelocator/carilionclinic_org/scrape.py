...
def fetch_data():
    ...
    data = '{"query":"*","rows":"2000","fields":["*_type","*_title","*_body_summary","*_en_url","*_field_given_name","*_field_surname","*_field_affiliations","*_en_provider_photo_uri","*_field_primaryphone_location","*_field_primaryphone","*_field_acceptsnewclients","*_field_acceptschildren","*_field_specialties","*_field_services","*_address_line1","*_locality","*_administrative_area","*_postal_code","*_en_location_hero_image_uri","*_field_service_areas","*_field_medical_categories","*_field_specialty_conditions","*_en_url","*_field_owned","*_latlon"],"sort":{"ss_title":"ASC"},"queryfields":["searchfields","ts_title"],"type":"edismax","filterquery":{"index_id":{"query":"ss_type:location"}},"geofilt":{},"bq":{}}'
