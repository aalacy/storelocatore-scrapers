...
def fetch_data(sgw: SgWriter):
    ...
    for i in range(0, 100):
        page_url = f"https://www.burgerking.no/locations?field_geofield_distance%5Borigin%5D%5Blat%5D=59.91408&field_geofield_distance%5Borigin%5D%5Blon%5D=10.752248&page={i}&target=Oslo"
        session = SgRequests()
        headers = {
