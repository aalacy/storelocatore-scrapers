...
def fetch_data(sgw: SgWriter):
    ...
    api_url = "https://production.lv.kfc.digital/api/store/v2/store.geo_search"
    session = SgRequests()
    headers = {
        ...
        "Referer": "https://kfc.lv/",
        "Connection": "keep-alive",
        "Cache-Control": "max-age=0",
        "TE": "trailers",
    }

    data = '{"coordinates":[56.922290000000004,24.170780000000008],"radiusMeters":100000,"channel":"website"}'
    r = session.post(api_url, headers=headers, data=data)
    js = r.json()["searchResults"]
    for j in js:
        a = j.get("store")
        page_url = "https://kfc.lv/restaurants"
