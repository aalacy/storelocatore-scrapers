...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.kaufland.bg/"
    api_url = "https://www.kaufland.bg/.klstorefinder.json"
    headers = {
    ...
    for j in js:
        ...
        page_url = f"https://www.kaufland.bg/moyat-kaufland/uslugi/filiali.storeName={store_number}.html"
