...
def fetch_data(sgw: SgWriter):
    ...
    api_url = "https://www.westernsecuritybank.com/_/api/branches/45.78179979999999/-108.5058942/500"
    session = SgRequests()
    headers = {
    ...
    for j in js["branches"]:
        ...
        page_url = "https://www.westernsecuritybank.com/locations"
...
if __name__ == "__main__":
    session = SgRequests()
    locator_domain = "https://www.westernsecuritybank.com"
    with SgWriter(
