...
def fetch_data():
    ...
    locator_domain = "https://supercmart.com"
    api_url = "https://supercmart.com/ajax/index.php"
    session = SgRequests()
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:88.0) Gecko/20100101 Firefox/88.0",
        "Referer": "https://supercmart.com/contact",
    }

    data = {
        "method": "POST",
        "apiurl": "https://supercmart.rsaamerica.com/Services/SSWebRestApi.svc/GetClientStores/1",
    }
    ...
    for j in js["GetClientStores"]:
        ...
        page_url = "https://supercmart.com/contact"
