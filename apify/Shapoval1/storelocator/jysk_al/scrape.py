...
def fetch_data(sgw: SgWriter):
    ...
    headers = {
        ...
        "dto": '{"kind":"server"}',
        "desired_lang": "sq",
        "Origin": "https://jysk.al",
        "Connection": "keep-alive",
        "Referer": "https://jysk.al/public/store",
    ...
    r = session.post(
        "https://jysk.al/public/clickkon/whf/list", headers=headers, data=data
    )
    js = r.json()
    for j in js:
        a = j.get("addresses")[0]
        page_url = "https://jysk.al/public/store"
