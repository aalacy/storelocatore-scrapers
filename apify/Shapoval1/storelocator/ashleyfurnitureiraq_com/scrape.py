...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://ashleyfurnitureiraq.com/"
    api_url = "https://store.ashleyfurnitureiraq.com/location.html"
    session = SgRequests()
    headers = {
    ...
    for d in div:
        ...
        page_url = "https://store.ashleyfurniture.uy/location.html"
        ...
        hours_of_operation = "".join(d.xpath(".//text()")).replace("\n", "").strip()
