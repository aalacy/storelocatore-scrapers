...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.kaufland.hr/"
    api_url = "https://www.kaufland.hr/.klstorefinder.json"
    headers = {
    ...
    for j in js:
        ...
        page_url = (
            f"https://www.kaufland.hr/usluge/poslovnica.storeName={store_number}.html"
        )
