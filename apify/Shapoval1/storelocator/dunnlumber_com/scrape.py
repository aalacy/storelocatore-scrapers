...
def get_urls():
    ...
    r = session.get("https://www.dunnlumber.com/locations#")
    tree = html.fromstring(r.text)
    return tree.xpath('//td[@class="DunnLeftNavigation"]//h5/a/@href')


def get_data(url):
    locator_domain = "https://www.dunnlumber.com/"
    ...
    text = "".join(tree.xpath('//a[contains(@href, "ll=")]/@href'))
    try:
        if text.find("ll=") != -1:
    ...
    hours_of_operation = tree.xpath("//h4[./time]//text()")
