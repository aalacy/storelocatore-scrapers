...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.kaufland.md"
    api_url = "https://www.kaufland.md/ru/.klstorefinder.json"
    headers = {
    ...
    for j in js:
        ...
        page_url = f"https://www.kaufland.md/ru/poleznoye/magazin.storeName={store_number}.html"
