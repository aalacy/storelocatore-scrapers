...
def fetch_data(sgw: SgWriter):
    ...
    api_url = (
        "https://www.collegiatepeaksbank.com/_/api/branches/38.841648/-106.1313087/500"
    )
    session = SgRequests()
    headers = {
    ...
    for j in js["branches"]:
        ...
        page_url = "https://www.collegiatepeaksbank.com/locations"
...
if __name__ == "__main__":
    session = SgRequests()
    locator_domain = "https://www.collegiatepeaksbank.com"
    with SgWriter(
