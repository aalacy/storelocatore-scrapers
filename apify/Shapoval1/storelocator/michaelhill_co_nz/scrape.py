...
def fetch_data():
    ...
    locator_domain = "https://www.michaelhill.co.nz/"
    api_url = "https://www.michaelhill.co.nz/on/demandware.store/Sites-MichaelHillNZ-Site/en_NZ/StoresHooks-GetStoreList?q=&display=&country=NZ&mode=checkstock&lat=-40.900557&lng=174.885971"
    session = SgRequests()
    headers = {
