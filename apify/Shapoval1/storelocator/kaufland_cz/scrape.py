...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.kaufland.cz/"
    api_url = "https://www.kaufland.cz/.klstorefinder.json"
    headers = {
    ...
    for j in js:
        ...
        page_url = f"https://www.kaufland.cz/aktualne/servis/prodejna.storeName={store_number}.html"
