...
def fetch_data(sgw: SgWriter):
    ...
    api_url = "https://www.banksanjuans.com/_/api/branches/37.271897/-107.8803706/500"
    session = SgRequests()
    headers = {
    ...
    for j in js["branches"]:
        ...
        page_url = "https://www.banksanjuans.com/locations"
        ...
        if hours_of_operation.find("Lobby") != -1:
            hours_of_operation = hours_of_operation.split("Lobby")[0].strip()
        if hours_of_operation.find("Mailing") != -1:
            hours_of_operation = hours_of_operation.split("Mailing")[0].strip()
...
if __name__ == "__main__":
    session = SgRequests()
    locator_domain = "https://www.banksanjuans.com/locations"
    with SgWriter(
