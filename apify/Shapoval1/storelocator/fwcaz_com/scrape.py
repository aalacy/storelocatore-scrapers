...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.fwcaz.com/"
    api_url = "https://www.fwcaz.com/api/v1/dealers?latitude=34.03054&longitude=-118.38458&radius=10000&pageSize=100&startPage=1&"
    session = SgRequests()
    headers = {
    ...
    for j in js:
        slug = j.get("id")
        page_url = (
            f"https://www.fwcaz.com/Locations/Branch-Locations/Dealer?dealerId={slug}"
        )
