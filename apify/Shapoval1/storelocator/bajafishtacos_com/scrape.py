...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.bajafishtacos.com/"
    page_url = "https://www.bajafishtacos.com/locations"
    session = SgRequests()
    headers = {
    ...
    div = tree.xpath('//div[@class="contact-card"]')
    for d in div:
        ...
        ad = (
            "".join(
                d.xpath('.//h3[text()="ADDRESS"]/following-sibling::p[1]/text()[2]')
            )
            .replace("\n", "")
            .strip()
        )
