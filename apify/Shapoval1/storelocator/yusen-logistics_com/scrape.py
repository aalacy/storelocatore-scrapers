        ...
        for d in div:
            ...
            for i in range(0, 5):
                data = {
                    ...
                    "view_base_path": "",
                    "view_dom_id": "b08488dc5af64df84e8bf1c1adbe81e61f0f6b8c5e8a0be78245d2f9172e46fc",
                    "pager_element": "0",
                    "field_office_region": f"{val}",
                    "lock_config_key": "7o-QBrh_qGd1zik3OfcZYFb19yqImJnqBaECS4T-BQ0",
                    "block_config_key": "7o-QBrh_qGd1zik3OfcZYFb19yqImJnqBaECS4T-BQ0",
                    "page": f"{i}",
                    "_drupal_ajax": "1",
                ...
                for j in js:
                    ...
                    for d in div:
                        ...
                        page_url = (
                            "https://www.yusen-logistics.com/about-us/find-an-office"
                        )
                        location_name = (
                            "".join(
                        ...
                        phone = (
                            "".join(
                                d.xpath(
                                    './/span[contains(text(), "TEL:")]/following-sibling::*[1]/*[1]//text()'
                                )
                            )
                            .replace("\n", "")
