...
def get_data(coords, sgw: SgWriter):
    lat, long = coords
    locator_domain = "https://morrisonsupply.com/"

    headers = {
        "User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:90.0) Gecko/20100101 Firefox/90.0",
        "Accept": "*/*",
        "Accept-Language": "ru-RU,ru;q=0.8,en-US;q=0.5,en;q=0.3",
        "Referer": "https://morrisonsupply.reece.com/",
        "content-type": "application/json",
        "authorization": "",
        "Origin": "https://morrisonsupply.reece.com",
    ...
    for j in js:
        ...
        page_url = "https://morrisonsupply.reece.com/location-search"
