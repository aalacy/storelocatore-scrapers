...
def fetch_data(sgw: SgWriter):
    ...
    api_url = "https://production.lt.kfc.digital/api/store/v2/store.geo_search"
    session = SgRequests()
    headers = {
        ...
        "Referer": "https://kfc.lt/",
        "Connection": "keep-alive",
        "Cache-Control": "max-age=0",
        "TE": "trailers",
    }

    data = '{"coordinates":[54.71451200000001,25.275363000000027],"radiusMeters":100000,"channel":"website"}'
    r = session.post(api_url, headers=headers, data=data)
    js = r.json()["searchResults"]
    for j in js:
        a = j.get("store")
        page_url = "https://kfc.lt/restaurants"
