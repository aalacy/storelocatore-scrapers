...
def get_urls():
    ...
    r = session.get("https://www.uniglassplus.com/sitemap.xml", headers=headers)
    tree = html.fromstring(r.content)
    return tree.xpath("//url/loc[contains(text(), '/locations/')]/text()")


def get_data(url, sgw: SgWriter):
    locator_domain = "https://www.uniglassplus.com/"
    ...
    hours_of_operation = (
        ...
        .replace("By appointment - By appointment", "By appointment")
        .strip()
    )
