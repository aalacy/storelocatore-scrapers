...
def fetch_data(sgw: SgWriter):
    ...
    api_url = "https://www.ccb-idaho.com/_/api/branches/42.8602272/-112.4498773/500"
    session = SgRequests()
    headers = {
    ...
    for j in js["branches"]:
        ...
        page_url = "https://www.ccb-idaho.com/locations"
...
if __name__ == "__main__":
    session = SgRequests()
    locator_domain = "https://www.ccb-idaho.com"
    with SgWriter(
