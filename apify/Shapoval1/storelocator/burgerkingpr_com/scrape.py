...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.burgerkingpr.com/"
    for i in range(0, 100):
        page_url = f"https://www.burgerkingpr.com/locations?field_geofield_distance%5Borigin%5D%5Blat%5D=18.40267&field_geofield_distance%5Borigin%5D%5Blon%5D=-66.05954&page={i}&target=San%20Juan"
        session = SgRequests()
        headers = {
