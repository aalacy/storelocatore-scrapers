...
def fetch_data():
    ...
    api_url = "https://www.michaelhill.ca/on/demandware.store/Sites-MichaelHillCA-Site/en_CA/StoresHooks-GetStoreList?q=&display=&country=CA&mode=checkstock&lat=56.130366&lng=-106.346771"
    session = SgRequests()
    headers = {
