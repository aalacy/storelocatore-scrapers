...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.kaufland.pl"
    api_url = "https://www.kaufland.pl/.klstorefinder.json"
    headers = {
    ...
    for j in js:
        ...
        page_url = (
            f"https://www.kaufland.pl/dla-klienta/sklepy.storeName={store_number}.html"
        )
