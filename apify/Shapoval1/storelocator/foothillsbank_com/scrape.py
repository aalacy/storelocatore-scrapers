...
def fetch_data(sgw: SgWriter):
    ...
    api_url = "https://www.foothillsbank.com/_/api/branches/32.6601027/-114.4092089/500"
    session = SgRequests()
    headers = {
    ...
    for j in js["branches"]:
        ...
        page_url = "https://www.foothillsbank.com/locations"
...
if __name__ == "__main__":
    session = SgRequests()
    locator_domain = "https://www.foothillsbank.com"
    with SgWriter(
