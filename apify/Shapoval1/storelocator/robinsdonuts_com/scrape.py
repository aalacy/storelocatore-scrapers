...
def fetch_data(sgw: SgWriter):
    with SgRequests() as http:
        ...
        for j in js:
            ...
            slug = j.get("llp_url")
            page_url = f"https://locations.robinsdonuts.com{slug}"
            a = j.get("store_info")
            ...
            headers = {
                ...
                "Authorization": "VKUHLIZZDXHUKKWJ",
                "Origin": "https://locations.robinsdonuts.com",
                "Connection": "keep-alive",
                "Referer": "https://locations.robinsdonuts.com/",
