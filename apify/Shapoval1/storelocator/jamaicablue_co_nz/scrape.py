...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "https://www.jamaicablue.co.nz"
    session = SgRequests()
    headers = {
    ...
    r = session.post(
        "https://www.jamaicablue.co.nz/wp-admin/admin-ajax.php",
        headers=headers,
        data=data,
    )
    js = r.json()["locations"]
    for j in js:
        ...
        page_url = "https://www.jamaicablue.co.nz/store-locations/"
        ...
        if hours_of_operation.find("Currently") != -1:
            hours_of_operation = hours_of_operation.split("Currently")[0].strip()
