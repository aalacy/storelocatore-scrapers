...
def fetch_data(sgw: SgWriter):
    ...
    locator_domain = "http://www.burgerking.com.uy/"
    for i in range(0, 5):
        page_url = f"http://www.burgerking.com.uy/locations?field_geofield_distance[origin][lat]=-34.90111&field_geofield_distance[origin][lon]=-56.164546&target=MONTEVIDEO&page={i}"
        session = SgRequests()
        headers = {
