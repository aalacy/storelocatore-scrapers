...
async function scrape() {
    ...
    var response = await axios.get('https://smoothiefactory.com/wp-admin/admin-ajax.php?action=store_search&max_results=1000&autoload=1');

    var stores = response.data.map(store => ({
        locator_domain: 'smoothiefactory.com',
