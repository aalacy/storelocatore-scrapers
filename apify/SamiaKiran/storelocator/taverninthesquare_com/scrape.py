...
DOMAIN = "https://www.taverninthesquare.com"
MISSING = SgRecord.MISSING


def fetch_data():
    if True:
        url = "https://www.taverninthesquare.com/locations"
        r = session.get(url, headers=headers)
        soup = BeautifulSoup(r.text, "html.parser")
        loclist = soup.find("ul", {"aria-hidden": "true"}).findAll("li")
        for loc in loclist:
