...
session = SgRequests()
website = "rickyrocketsfuelcenter_com"
...
DOMAIN = "https://www.rickyrocketsfuelcenter.com/"
MISSING = SgRecord.MISSING


def fetch_data():
    if True:
        url = "https://www.rickyrocketsfuelcenter.com/locations-1"
        ...
        for loc in loclist:
            ...
            address = loc.find("p").text.split("Call: ")
            phone = address[1]
            address = address[0]
