...
DOMAIN = "https://phocafe.co.uk/"
MISSING = SgRecord.MISSING


def fetch_data():
    if True:
        url = "https://www.phocafe.co.uk/locations-search/"
        ...
        for loc in loclist:
            ...
            soup = BeautifulSoup(r.text, "html.parser")
            location_name = loc.find("p").text
            temp = soup.findAll("div", {"class": "contact-details"})
            if "Opening Soon" in temp[0].text:
                continue
