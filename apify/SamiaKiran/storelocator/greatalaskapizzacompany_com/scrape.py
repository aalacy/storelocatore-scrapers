...
session = SgRequests()
website = "greatalaskapizzacompany_com"
...
DOMAIN = "https://www.greatalaskapizzacompany.com/"
...
def fetch_data():
    if True:
        ...
        loclist = soup.findAll("li", {"class": "menu-item-type-post_type"})[:-2]
        for loc in loclist:
            temp = loc.find("a")
            ...
            phone = soup.find("a", {"class": "phoneNumber"}).text.replace("CALL", "")
            hours_of_operation = (
