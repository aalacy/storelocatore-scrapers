...
def record_initial_requests(http: SgRequests, state: CrawlState) -> bool:
    url = "https://stores.champssports.com/"
    store_url_list = []
    http = SgRequests()
    ...
    for country in country_list:
        ...
        country_url = "https://stores.champssports.com/" + country["href"]
        if count > 1:
                    ...
                    if count > 1:
                        ...
                        for loc in loclist:
                            loc_link = loc.find("a", {"data-ya-track": "businessname"})[
                                "href"
                            ].replace("../..", "https://stores.champssports.com")
