...
headers = {
    ...
    "origin": "https://www.fuentenicanor.cl/",
    "referer": "https://www.fuentenicanor.cl/",
}

DOMAIN = "https://www.fuentenicanor.cl/"
...
def fetch_data():
    if True:
        url = "https://www.fuentenicanor.cl/locales"
        ...
        for loc in loclist:
            ...
            yield SgRecord(
                ...
                page_url="https://www.fuentenicanor.cl/locales",
