...
def fetch_data():
    ...
    locator_domain = 'https://www.magicutssalons.com/'
    ...
    while coord:    
        x = coord[0]
        y = coord[1]
        url = 'https://info3.regiscorp.com/salonservices/siteid/20/salons/searchGeo/map/' + str(x) + '/' + str(y) + '/0.8/0.35/true'
        ...
        for loc in res_json:
            ...
            page_json_url = 'https://info3.regiscorp.com/salonservices/siteid/20/salon/' + str(store_number)
