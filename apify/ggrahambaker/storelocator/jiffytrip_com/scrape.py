...
def fetch_data():
    ...
    body = soup.find(class_="table location-table")
    divs = body.find_all("tr")
    ...
    for div in divs[1:]:
        ...
        store_data = [locator_domain, to_scrape, location_name, street_address, city, state, zip_code, country_code,
