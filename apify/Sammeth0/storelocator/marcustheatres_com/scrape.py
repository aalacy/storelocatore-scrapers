...
# Begin scraper
	...
	for i in link:
		...
		print(phones)
		location_type.append(i.find_element_by_xpath('/html/body/div/div/section/section/div[1]/div[3]/section[1]/div/div[1]/a/div/p').text)
		print(location_type)
	...
	for l in range(len(locs)):
		...
		row.append(location_type[l] if location_type[l] else "<MISSING>")
