...
def get_data(coords, sgw: SgWriter):
    ...
    r = session.post(
        f"https://stores.ashleyfurniture.com/umbraco/surface/locate/GetDataByCoordinates?longitude={long}&latitude={lat}&distance=500&units=miles&amenities=&paymentMethods=",
        headers=headers,
    )
