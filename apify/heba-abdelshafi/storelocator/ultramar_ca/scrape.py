...
def fetch_data():
    ...
    for co in country:
        ...
        for i in location_data_urls:
            ...
            try:
                data['hours_of_operation'].append(driver.find_element_by_xpath('//div[@class="station__hours"]/div[2]/span[2]').text)
            except:
                try:
                    data['hours_of_operation'].append(driver.find_element_by_xpath('//div[@class="station__hours"]/div/span[2]').text)
                except:
