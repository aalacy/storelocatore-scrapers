...
def get_urls():
    ...
    for b in batches:
        url = f'https://sls-api-service.sweetiq-sls-production-east.sweetiq.com/eWhSvxJrhmw6w9pJkeeXCkK12mi4XC/locations-details?locale=en_CA&ids={",".join(b)}&cname=locations.quesada.ca'
        urls.append(url)
