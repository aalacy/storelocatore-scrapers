...
def fetch_data(sgw: SgWriter):
    api = "https://lemospet.com/wp-admin/admin-ajax.php?action=store_search&lat=34.42126&lng=-119.48757&max_results=25&search_radius=500"
...
if __name__ == "__main__":
    locator_domain = "https://lemospet.com/"
    page_url = "https://lemospet.com/location/"
    headers = {
