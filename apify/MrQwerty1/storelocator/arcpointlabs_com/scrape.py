...
def get_data(coord):
    rows = []
    lat, lon = coord
    locator_domain = "https://www.arcpointlabs.com/"
    api_url = f"https://www.arcpointlabs.com/wp-admin/admin-ajax.php?action=store_search&lat={lat}&lng={lon}&max_results=50&search_radius=200&autoload=1"
