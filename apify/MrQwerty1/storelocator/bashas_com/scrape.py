...
def get_data(coord):
    rows = []
    lat, lon = coord
    locator_domain = "https://www.bashas.com/"
    api_url = f"https://www.bashas.com/wp-admin/admin-ajax.php?action=store_search&lat={lat}&lng={lon}&max_results=75&search_radius=200"
