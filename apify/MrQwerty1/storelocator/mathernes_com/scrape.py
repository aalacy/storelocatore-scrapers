...
def get_token():
    ...
    data = {
        "app_key": "mathernes",
        "referrer": "https://www.mathernes.com/my-store/store-locator",
    }
...
def fetch_data():
    out = []
    locator_domain = "https://www.mathernes.com/"
    token = get_token()
    api_url = f"https://api.freshop.com/1/stores?app_key=mathernes&has_address=true&is_selectable=true&limit=-1&token={token}"
    session = SgRequests()
