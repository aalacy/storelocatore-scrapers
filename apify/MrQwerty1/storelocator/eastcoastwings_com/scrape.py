...
def get_data(page_url):
    ...
    line = "".join(tree.xpath("//p[@class='address-container']/text()")).strip()
    ...
    country_code = "US"
    store_number = (
        "".join(tree.xpath("//div[@data-post-id]/@data-post-id")) or "<MISSING>"
    )
    phone = (
        "".join(tree.xpath("//p[@class='telephone']/a/text()")).strip() or "<MISSING>"
    )
    latitude = (
