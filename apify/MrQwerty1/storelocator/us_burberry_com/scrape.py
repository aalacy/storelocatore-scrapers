...
def fetch_data():
    ...
    session = SgRequests()
    r = session.get(f'https://api.burberry.com/services/sites/v1?language=en&country=US&limit=100')
    js = r.json()['data']
    ...
    for j in js:
        ...
        page_url = f"https://us.burberry.com/store-locator/united-states/-/{store_number}"
