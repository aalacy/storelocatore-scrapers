...
def fetch_data(sgw: SgWriter):
    api = "https://api.valora-stores.com/_index.php?apiv=2.0.9&c=21&a=data&ns=storefinder&l=de&key=backwerk887mghr"
...
if __name__ == "__main__":
    locator_domain = "hhttps://back-werk.de/"
    page_url = "https://back-werk.de/de/standorte/"
    headers = {
