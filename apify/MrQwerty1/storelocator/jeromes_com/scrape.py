...
def get_urls():
    session = SgRequests()
    r = session.get("https://www.jeromes.com/locations")
    tree = html.fromstring(r.text)

    return tree.xpath("//div[@class='loc_tile']/a/@href")


def get_data(url):
    locator_domain = "https://www.jeromes.com/"
    page_url = f"https://www.jeromes.com{url}"
