...
def generate_links():
    session = SgRequests()
    r = session.get("https://locations.manhattanbagel.com/us.json")
...
def get_urls(states):
    for state in states.values():
        ...
        if children is None:
            yield f"https://locations.manhattanbagel.com/{state['url']}.json"
        else:
...
def get_data(url):
    ...
    locator_domain = "https://www.manhattanbagel.com/"
