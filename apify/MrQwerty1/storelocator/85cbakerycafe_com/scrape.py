...
def get_data(coord):
    rows = []
    lat, lon = coord
    locator_domain = "https://www.85cbakerycafe.com/"
    api_url = f"https://www.85cbakerycafe.com/wp-admin/admin-ajax.php?action=store_search&lat={lat}&lng={lon}&max_results=50&search_radius=200"
