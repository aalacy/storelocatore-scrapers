...
def generate_headers():
    ...
    token = init.json()[0]
    session_id = init.cookies.get('SESSff6ed92e85117919b687e9a16062bf17')

    headers = {'X-CSRF-Token': token}
    cookies = {
        'SESSff6ed92e85117919b687e9a16062bf17': session_id,
        'XSRF-TOKEN': token,
    }
...
def fetch_data():
    ...
    r = session.get('https://www.spring-market.com/api/m_store_location?store_type_ids=1,2,3',
