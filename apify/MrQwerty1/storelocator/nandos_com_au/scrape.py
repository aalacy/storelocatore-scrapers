...
def fetch_data(sgw: SgWriter):
    api = "https://api.nandos.com.au/public/graphql"
    ...
    for j in js:
        ...
        slug = location_name.replace(" ", "-").replace("(", "").replace(")", "").lower()
        page_url = f"https://www.nandos.com.au/restaurants/{state.lower()}/{slug}"
...
if __name__ == "__main__":
    locator_domain = "https://www.nandos.com.au"
    headers = {
        "User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:94.0) Gecko/20100101 Firefox/94.0",
        "Accept": "application/json, text/plain, */*",
        "Accept-Language": "ru,en-US;q=0.7,en;q=0.3",
        "Content-Type": "application/json; charset=UTF-8",
        "Origin": "https://www.nandos.com.au",
