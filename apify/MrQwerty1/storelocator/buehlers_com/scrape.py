...
def get_token():
    session = SgRequests()
    data = {"app_key": "buehlers", "referrer": "https://www.buehlers.com/store-locator"}
...
def fetch_data():
    out = []
    locator_domain = "https://www.buehlers.com/"
    token = get_token()
    api_url = f"https://api.freshop.com/1/stores?app_key=buehlers&has_address=true&is_selectable=true&limit=-1&token={token}"
