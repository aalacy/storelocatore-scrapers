...
def fetch_data():
    ...
    for i in ids:
        r = session.get(f'https://www.digitalservices.ford.com/ql/api/v2/dealer?dealer={i}', headers=headers)
        js = r.json()['qlDealer']
        ...
        store_number = i
        page_url = f'https://www.quicklane.com/en-us/oil-change-tire-auto-repair-store/' \
