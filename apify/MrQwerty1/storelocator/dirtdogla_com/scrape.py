...
def fetch_data():
    out = []
    locator_domain = "https://www.dirtdogla.com/"
    api_url = (
        "https://cdn.storelocatorwidgets.com/json/58c94192b43a35e7c0bec6ebfcdebd2e"
    )
    session = SgRequests()
    ...
    for j in js:
        ...
        street_address = (
            f"{a.get('address1')} {a.get('address2') or ''}".replace("None", "").strip()
            or "<MISSING>"
        )
        ...
        page_url = "https://www.dirtdogla.com/locations"
