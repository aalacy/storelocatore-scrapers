...
def fetch_data(sgw: SgWriter):
    api = "https://location.salsamexicangrill.co.za/search"

    for cnt in range(0, 5000, 50):
        params = {
            "per": "50",
            "offset": str(cnt),
        }
...
if __name__ == "__main__":
    locator_domain = "https://salsamexicangrill.co.za"
    headers = {
        "User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:100.0) Gecko/20100101 Firefox/100.0",
        "Accept": "application/json",
        "Referer": "https://location.salsamexicangrill.co.za",
    }
    session = SgRequests()
