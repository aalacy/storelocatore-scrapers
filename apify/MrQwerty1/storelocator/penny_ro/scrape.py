...
def fetch_data(sgw: SgWriter):
    api = "https://www.penny.ro/api/stores"
    r = session.get(api, headers=headers)
    js = r.json()

    for j in js:
        location_name = "Penny Markt"
...
if __name__ == "__main__":
    locator_domain = "https://www.penny.ro/"
    page_url = "https://www.penny.ro/magazinul-meu"
    headers = {
        ...
        "Referer": "https://www.pennymarket.ro/",
