...
def get_ids():
    ids = set()
    api = "https://ecgplacesmw.colruyt.be/ecgplacesmw/v3/nl/places/searchPlaces?ensignId=8&placeTypeId=1&countryName=Belgi%C3%AB"
...
def get_data(store_number, sgw: SgWriter):
    api = f"https://ecgplacesmw.colruyt.be/ecgplacesmw/v3/nl/places/getDetails?placeId={store_number}"
    r = session.get(api, headers=headers)
    j = r.json()
...
if __name__ == "__main__":
    locator_domain = "https://www.colruyt.be/"
    headers = {
