...
def fetch_data(sgw: SgWriter):
    api = "https://www.pennymarket.it/api/stores"
    r = session.get(api, headers=headers)
    js = r.json()

    for j in js:
        location_name = "Penny Market"
...
if __name__ == "__main__":
    locator_domain = "https://www.pennymarket.it/"
    page_url = "https://www.pennymarket.it/punti-vendita"
    headers = {
        ...
        "Referer": "https://www.pennymarket.it/",
