...
def fetch_data(sgw: SgWriter):
    ...
    for j in js:
        ...
        page_url = f"https://www.ullapopken.eu/en/storefinder#!/l/-/-/{store_number}"
        phone = j.get("phone")
        latitude = j.get("lat")
        longitude = j.get("lng")
...
if __name__ == "__main__":
    locator_domain = "https://www.ullapopken.eu/"
    headers = {
