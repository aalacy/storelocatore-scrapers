...
def fetch_data(sgw: SgWriter):
    api = "https://www.douglas.hr/StoreLocator/search"
    data = {
        "lat": "0",
        "lng": "0",
        "distance": "0",
    ...
    for d in divs:
        ...
        postal = "".join(re.findall(r"\d{5,6}", raw_address))
...
if __name__ == "__main__":
    locator_domain = "https://www.douglas.hr/"
    page_url = "https://www.douglas.hr/storeLocator"
    headers = {
