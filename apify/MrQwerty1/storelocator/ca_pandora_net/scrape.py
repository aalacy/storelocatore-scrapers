...
def fetch_data():
    out = []
    url = 'https://stores.pandora.net/en-ca/'
    api_url = 'https://maps.pandora.net/api/getAsyncLocations?search=10001&level=domain' \
              '&template=domain&limit=4000&radius=5000'
