...
def get_urls():
    r = session.get("https://www.jollibee-italia.it/i-nostri-negozi")
    tree = html.fromstring(r.text)

    return tree.xpath("//a[contains(text(), 'SCOPRI DI PIÙ')]/@href")


def get_data(slug, sgw: SgWriter):
    page_url = f"https://www.jollibee-italia.it{slug}"
...
if __name__ == "__main__":
    locator_domain = "https://www.jollibee-italia.it/"
    session = SgRequests()
