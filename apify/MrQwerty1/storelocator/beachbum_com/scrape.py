...
def get_data(coord):
    rows = []
    lat, lon = coord
    locator_domain = "https://beachbum.com/"
    api_url = f"https://beachbum.com/wp-admin/admin-ajax.php?action=store_search&lat={lat}&lng={lon}&max_results=40&search_radius=50"
    headers = {
    ...
    for j in js:
        page_url = f"https://beachbum.com{j.get('url')}"
