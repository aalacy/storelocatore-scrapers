...
def get_urls():
    r = session.get("https://www.freshfoods.us/StoreLocator/")
    tree = html.fromstring(r.text)

    return tree.xpath("//a[@class='StoreViewLink']/@href")
...
def get_data(page_url, sgw: SgWriter):
    ...
    location_name = city
    phone = "".join(tree.xpath("//p[@class='PhoneNumber']/a/text()"))
...
if __name__ == "__main__":
    locator_domain = "https://www.freshfoods.us/"
    session = SgRequests()
