...
def fetch_data(sgw: SgWriter):
    api = "https://api.valora-stores.com/_index.php?apiv=2.0.9&c=21&a=data&ns=storefinder&l=en&key=avecHnbG6Tr"
...
if __name__ == "__main__":
    locator_domain = "https://www.ditsch.de/"
    page_url = "https://www.ditsch.de/en/shops/standorte/"
    headers = {
