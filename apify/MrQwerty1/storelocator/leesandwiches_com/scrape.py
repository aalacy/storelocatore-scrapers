...
def get_data(coord):
    rows = []
    lat, lon = coord
    data = {"action": "csl_ajax_search", "radius": "200", "lat": lat, "lng": lon}
    locator_domain = "https://leesandwiches.com/"
    api_url = "https://leesandwiches.com/wp-admin/admin-ajax.php"
    ...
    for j in js:
        ...
        country_code = "US"
        store_number = j.get("linked_postid") or "<MISSING>"
