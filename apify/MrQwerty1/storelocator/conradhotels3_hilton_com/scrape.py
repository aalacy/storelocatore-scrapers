...
def get_zones():
    ...
    data = '{"operationName":"hotelMapZones","variables":{"brandCode":"CH"},"query":"query hotelMapZones($brandCode: String) {\\n hotelMapZones(brandCode: $brandCode) {\\n id {\\n x\\n y\\n __typename\\n }\\n bounds {\\n southwest {\\n latitude\\n longitude\\n __typename\\n }\\n northeast {\\n latitude\\n longitude\\n __typename\\n }\\n __typename\\n }\\n countries {\\n countryCode\\n stateCodes\\n __typename\\n }\\n brandCodes\\n __typename\\n }\\n}\\n"}'
...
def get_data(zone):
    ...
    session = SgRequests()
    del zone["__typename"]
    locator_domain = "https://conradhotels3.hilton.com/"
    ...
    for j in js:
        ...
        if not (country_code == "US" or country_code == "CA" or country_code == "GB"):
            continue
