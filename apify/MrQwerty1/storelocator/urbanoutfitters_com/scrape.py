...
def fetch_data():
    ...
    api_url = 'https://www.urbanoutfitters.com/api/misl/v1/stores/search?&country=US,' \
              'CA&urbn_key=937e0cfc7d4749d6bb1ad0ac64fce4d5 '
    ...
    for j in js:
        '''
        country_code = j['addresses']['iso2']['country']
        ...
        if location_name.lower().find('closed') != -1 or location_name.lower().find('soon') != -1:
            continue
        ...
        page_url = f"https://www.urbanoutfitters.com/api/misl/v1/stores/search?" \
