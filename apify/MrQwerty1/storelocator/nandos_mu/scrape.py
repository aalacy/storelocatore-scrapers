...
def get_urls(coords):
    ...
    r = session.post(
        "https://www.nandos.mu/eat/restaurant_search_results",
        headers=headers,
        data=data,
    )
...
def get_data(slug, sgw: SgWriter):
    page_url = f"https://www.nandos.mu{slug}"
...
def fetch_data(sgw: SgWriter):
    ...
    search = DynamicGeoSearch(
        country_codes=[SearchableCountries.MAURITIUS],
...
if __name__ == "__main__":
    ...
    locator_domain = "https://www.nandos.mu/"
    with SgWriter(
        SgRecordDeduper(
