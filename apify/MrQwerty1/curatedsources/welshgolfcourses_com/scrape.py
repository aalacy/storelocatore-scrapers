...
def get_urls():
    session = SgRequests()
    r = session.get("https://www.welshgolfcourses.com/atoz.html")
...
def get_data(url):
    locator_domain = "https://www.welshgolfcourses.com/"
    page_url = f"https://www.welshgolfcourses.com{url}"
    ...
    if "SWANSEA" in postal:
        city = "SWANSEA"
        postal = postal.replace("SWANSEA", "")
    country_code = "GB"
