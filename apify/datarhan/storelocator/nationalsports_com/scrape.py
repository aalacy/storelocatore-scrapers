...
def fetch_data():
    ...
    DOMAIN = 'nationalsports.com'

    start_url = 'https://cdn.shopify.com/s/files/1/1956/9819/t/9/assets/stores.json'
    headers = {
    ...
    for poi in data['data']:
        ...
        for key, value in poi.items():
            if 'opening' in key:
                day = key.split('_')[0]
                if not hoo_dict.get(day):
                    hoo_dict[day] = {}
                    hoo_dict[day]['open'] = value
                else:
                    hoo_dict[day]['open'] = value
            if 'closing' in key:
                day = key.split('_')[0]
