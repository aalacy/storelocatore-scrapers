...
def fetch_data():
    ...
    search_url = "https://www.yellowmap.de/Partners/AldiNord/Search.aspx?BC=ALDI|ALDN&Search=1&Layout2=True&Locale=de-DE&PoiListMinSearchOnCountZeroMaxRadius=50000&SupportsStoreServices=true&Country=L&Zip={}&Town=&Street=&Radius=100000"
    all_codes = DynamicZipSearch(
        country_codes=[SearchableCountries.LUXEMBOURG], expected_search_radius_miles=100
    )
    for code in all_codes:
        ...
        for poi_html in all_locations:
            ...
            item = SgRecord(
                ...
                page_url="https://www.aldi.lu/de/information/filialen-und-oeffnungszeiten.html",
