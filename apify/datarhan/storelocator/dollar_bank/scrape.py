...
def fetch_data():
    ...
    for lat, lng in all_coordinates:
        ...
        headers = {
            ...
            "Cookie": "BIGipServerlocations_dollar_bank_https.app~locations_dollar_bank_https_pool=3624344074.47873.0000; _gcl_au=1.1.1897968214.1610053191; _gid=GA1.2.1908261265.1610053191; nmstat=1c8287f1-0d5f-b862-d498-fdfefee8feed; _fbp=fb.1.1610053192394.73768629; _dc_gtm_UA-18144621-12=1; _ga=GA1.1.1225520427.1610053191; _ga_Y4EF12QV9V=GS1.1.1610191681.6.0.1610191684.0; _gali=autocomplete",
