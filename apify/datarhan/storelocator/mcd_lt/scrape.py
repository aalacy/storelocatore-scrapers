...
def fetch_data():
    ...
    start_url = "https://mcd.lt/wp-admin/admin-ajax.php"
    domain = "mcd.lt"
    hdr = {
    ...
    for poi in data["data"]:
        ...
        hoo = loc_dom.xpath(
            '//div[a[contains(text(), "Restoranų darbo laikas")]]/following-sibling::div//table[@class="location-hours-table"]//text()'
        )
