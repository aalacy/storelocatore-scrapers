...
def fetch_data():
    ...
    url = 'https://www.ediblearrangements.ca/stores/store-locator.aspx/GetStoresList'
    payload = "{'AreaName':'M4B 1B3','Distance':'50000'}"
    headers = {
        'authority': 'www.ediblearrangements.ca',
        'accept': 'application/json, text/javascript, */*; q=0.01',
        'accept-encoding': 'gzip, deflate, br',
        'accept-language': 'ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7,pt;q=0.6',
        'content-type': 'application/json; charset=UTF-8',
        'origin': 'https://www.ediblearrangements.ca',
    ...
    for point_data in all_data['_Data']:
        store_url = 'https://www.ediblearrangements.ca/stores/{}'.format(point_data['PageFriendlyURL']) 
