...
def fetch_data():
    ...
    all_states = dom.xpath('//h1[contains(text(), "View All Stores")]/following-sibling::div[1]//a/@href')
    for state_url in all_states:
        ...
        all_stores = state_dom.xpath('//div[@class="inner-container storefinder-details view-all-stores"]/div//div')
        for store_data in all_stores:
            ...
            geo_data = store_dom.xpath('//a[@class="link-directions"]/@href')[0].split('/')[-1]
