...
def fetch_data():
    ...
    start_url = "https://www.food-world-stores.com/StoreLocator/State/?State=GA"
    ...
    all_locations = dom.xpath(
        '//div[@id="StoreLocator"]//a[contains(text(), "View")]/@href'
    )
    for store_url in all_locations:
        ...
        store_number = loc_response.url.split("L=")[-1].split("&")[0]
