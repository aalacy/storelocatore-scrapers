...
def fetch_data():
    with SgFirefox() as driver:
        headers = SgSeleniumDelay.get_default_headers_for(driver, 'https://www.style-encore.com/locations')
        for elem in headers:
    ...
    for location_data in data['Items']:
        ...
        store_url = 'https://www.style-encore.com/locations/{}'.format(location_data['xp']['slug'])
