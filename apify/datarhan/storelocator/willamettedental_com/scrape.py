...
def fetch_data():
    ...
    start_url = "https://locations.willamettedental.com/search.html?q=Seattle%2C+WA&r=3000&languages="
    ...
    for poi_html in all_locations:
        ...
        location_name = poi_html.xpath('.//a[@class="location-card-titleLink"]/text()')
        location_name = location_name[0] if location_name else "<MISSING>"
        street_address = poi_html.xpath('.//span[@class="c-address-street-1"]/text()')
