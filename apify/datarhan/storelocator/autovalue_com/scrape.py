...
def fetch_data():
    ...
    for code in all_codes:
        body = (
            '{"request":{"appkey":"F8FB03E8-C24B-11DD-AE46-C45F0AC4B31A","formdata":{"geoip":false,"dataview":"store_default","limit":5000,"geolocs":{"geoloc":[{"addressline":"'
            + code
            + '","country":"","latitude":"","longitude":""}]},"searchradius":"18|25|50|100|250","where":{"or":{"location_type":{"in":""}}},"false":"0"}}}'
        )
        ...
        for poi in all_poi:
            ...
            if store_number != "<MISSING>":
                store_url = "https://locations.autovalue.com/{}/{}/{}/".format(
