...
def fetch_data():
    ...
    frm = {"operationName":"getLocations","variables":{"input":{"northEast":{"latitude":51.82783930427531,"longitude":-43.929211062500016},"southWest":{"latitude":34.51407754366117,"longitude":-114.50538293750002},"distanceFrom":{"latitude":43.793547,"longitude":-79.217297},"handoffMode":"PICKUP","offset":0,"limit":500}},"query":"query getLocations($input: LocationFilter) {\n  getLocations(input: $input) {\n    id\n    name\n    storeName\n    streetAddress\n    city\n    state\n    country\n    telephone\n    zipCode\n    latitude\n    longitude\n    utcOffset\n    hours {\n      baseHours {\n        day\n        endDay\n        hourFrom\n        hourFromSuffix\n        hourTo\n        hourToSuffix\n        handoffMode\n      }\n    }\n    distance {\n      value\n      unit\n    }\n  }\n}\n"}
    hdr = {
        'accept': '*/*',
        'authorization': "",
