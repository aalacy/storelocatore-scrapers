...
def fetch_data():
    ...
    start_url = "https://www.renault.pe/concesionarios/"
    domain = "renault.pe"
    hdr = {
    ...
    data = session.get(
        "https://middleware.derco.com.pe/api/v4/subsidiaries/filters", headers=hdr
    ).json()
    for r in data["filters"]["regions"]:
        ...
        for poi_html in all_locations:
            ...
            geo = poi_html.xpath(".//a/@href")[0].split("/")[-1].split(",")
            hoo = poi_html.xpath(
