...
def fetch_data():
    ...
    start_url = (
        "https://www.duncans.com.au/store-locator/results/{}%2C{}?from={}&postcode={}"
    )
    ...
    for code, coords in all_codes:
        lat, lng = coords
        response = session.get(start_url.format(lat, lng, code, code), headers=hdr)
        ...
        for url in all_locations:
            ...
            phone = phone[0] if phone and phone[0] != "TBA" else ""
