...
def fetch_data():
    ...
    start_url = "https://www.geocms.it/Server/servlet/S3JXServletCall?parameters=method_name%3DGetObject%26callback%3Dscube.geocms.GeoResponse.execute%26id%3D1%26clear%3Dtrue%26query%3D(%255Bsales%255D%253D%255Btrue%255D%2520OR%2520%255Bassistance%255D%253D%255Btrue%255D)%2520AND%2520%255BcountryIsoCode2%255D%253D%255BCA%2520OR%2520us%255D%26licenza%3Dgeo-maseratispa%26progetto%3DDealerLocator%26lang%3DALL&encoding=UTF-8"
    ...
    for poi in data["L"][0]["O"]:
        ...
        location_name = poi["U"]["dealername"]
