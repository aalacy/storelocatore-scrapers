...
Apify.main(async () => {
  ...
  await requestQueue.addRequest({
    url: 'https://www.citymarket.com/storelocator-sitemap.xml',
    userData: {
      urlType: 'initial',
    },
  });
  ...
  const crawler = new Apify.PuppeteerCrawler({
    ...
    handlePageFunction: async ({
      ...
      if (request.userData.urlType === 'initial') {
        ...
        const locationUrls = urls.filter(e => e.match(/www.citymarket.com\/stores\/details\//))
