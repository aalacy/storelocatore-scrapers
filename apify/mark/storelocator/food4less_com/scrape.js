...
Apify.main(async () => {
  ...
  await requestQueue.addRequest({
    url: 'https://www.food4less.com/storelocator-sitemap.xml',
    userData: {
      urlType: 'initial',
    },
  });
    ...
    handlePageFunction: async ({
      ...
      if (request.userData.urlType === 'detail') {
        if (await page.$(locationObjectSelector) !== null) {
          ...
          const hours = extractHourString(locationObject.openingHours);
