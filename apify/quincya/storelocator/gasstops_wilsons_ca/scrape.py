...
def fetch_data():
    ...
    base_links = [
        "https://gasstops.wilsons.ca/wp-admin/admin-ajax.php?action=store_search&lat=46.5653163&lng=-66.46191639999999&max_results=100&search_radius=500&filter=24",
    ...
    for base_link in base_links:
        ...
        for store in stores:
            ...
            location_type = store["_24HourLocation"]
