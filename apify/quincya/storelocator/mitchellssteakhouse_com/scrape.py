...
def fetch_data(sgw: SgWriter):
    ...
    base_link = "https://www.mitchellssteakhouse.com/"
    ...
    items = base.main.find_all(class_="btn btn-brand")
    locator_domain = "mitchellssteakhouse.com"

    for item in items:
        link = "https://www.mitchellssteakhouse.com" + item["href"]
        ...
        hours_of_operation = (
            base.find(id="intro").p.find_next("p").get_text(" ").split("VIP")[0].strip()
        )
