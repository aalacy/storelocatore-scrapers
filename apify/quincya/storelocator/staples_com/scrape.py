...
def fetch_data(sgw: SgWriter):
    base_link = "https://stores.staples.com/index.html"
    ...
    final_links = []
    locator_domain = "https://www.staples.com/"

    state_links = []
    states = base.find_all(class_="Directory-listLink")
    for state in states:
        state_links.append("https://stores.staples.com/" + state["href"].split("/")[0])
    ...
    for state_link in state_links:
        ...
        for city in cities:
            city_link = "https://stores.staples.com/" + city["href"]
            ...
            if count == "1":
                ...
                for final_item in final_items:
                    final_link = (
                        "https://stores.staples.com/" + final_item["href"]
                    ).replace("../", "")
    ...
    for final_link in final_links:
        ...
        street_address = (
            base.find(class_="c-address-street-1")
            .text.split("(@")[0]
            .split("(Wilton")[0]
            .strip()
        )
        city = base.find(class_="c-address-city").text.split("(")[0].strip()
        ...
        store_number = base.find(class_="Core-storeId").text.split("#")[1]
        location_type = ""
