...
logger = SgLogSetup().get_logger('magnusonhotels_com__brand__magnuson__soft-brand-by-magnuson-worldwide')
...
def fetch_data():
	...
	base_link = "https://www.magnusonhotels.com/brand/soft-brand-by-magnuson-worldwide/"
