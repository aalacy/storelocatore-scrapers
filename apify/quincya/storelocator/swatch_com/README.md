Data pulled via API. location_type set as <MISSING> when isRetailShop, isKIosk, isKioskorShop etc are all False, or comma separated list of all categories that are True.
