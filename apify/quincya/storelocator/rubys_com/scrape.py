...
def fetch_data():
    ...
    base_link = "https://www.rubys.com/locations21/"
    ...
    items = base.find_all(class_="fg-thumb")
    ...
    for item in items:
        ...
        if "locations" in link:
            ...
            if link == "https://rubysshakeshop.com":
                ...
                phone = "(818) 747-2070"
                hours_of_operation = (
                    base.find(class_="footer-widget-single footer-widget-middle")
                    .find_all("p")[-1]
                    .text.replace("\n", " ")
                )
                latitude = "34.165903"
