...
def fetch_data():
	...
	base_link = 'https://c2b-services.bmw.com/c2b-localsearch/services/cache/v4/ShowAll?country=ca&category=BD&clientid=UX_NICCE_FORM_DLO'
	...
	for item in items:
		...
		street_address = item.street.text.strip()
		if street_address[-1:] == ",":
