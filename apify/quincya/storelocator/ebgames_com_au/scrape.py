...
def fetch_data(sgw: SgWriter):
    ...
    base_link = "https://www.ebgames.com.au/stores"

    locator_domain = "https://www.ebgames.com.au/"
    ...
    with uc.Chrome(
        ...
        for store in stores:
            ...
            if (
                "shop" in store["AddressLine1"].lower()
                or "plaza" in store["AddressLine1"].lower()
                or "showroom" in store["AddressLine1"].lower()
                or "post" in store["AddressLine1"].lower()
            ):
                street_address = store["AddressLine2"]
            else:
                street_address = raw_address
            street_address = street_address.split(", Auckland")[0].split("(")[0].strip()
