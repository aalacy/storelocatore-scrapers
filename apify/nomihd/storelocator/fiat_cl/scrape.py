...
headers = {
    "authority": "www.fiat.cl",
    "accept": "application/json, text/javascript, */*; q=0.01",
    "accept-language": "en-US,en-GB;q=0.9,en;q=0.8",
    "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
    "origin": "https://www.fiat.cl",
    "referer": "https://www.fiat.cl/propietarios/concesionarios/",
...
def fetch_data():
    # Your scraper here
    search_url = "https://www.fiat.cl/propietarios/concesionarios/"
    api_url = "https://www.fiat.cl/wp-admin/admin-ajax.php"
    ...
    with SgRequests() as session:
        ...
        for no, store in enumerate(stores, 1):
            ...
            headers["Referer"] = "https://www.fiat.cl/propietarios/concesionarios/"
