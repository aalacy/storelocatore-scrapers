...
def fetch_data():
    # Your scraper here
    search_url = "https://sanjosesoriginal.com/locations/"
    ...
    with SgRequests() as session:
        ...
        stores = search_sel.xpath("//div[@data-lat]")
        ...
        for store in stores:
            ...
            hours = list(
                filter(
                    ...
                    [
                        x.strip()
                        for x in store.xpath('.//*[@data-title="Open Hours"]//text()')
                    ],
                )
            )
            hours_of_operation = (
