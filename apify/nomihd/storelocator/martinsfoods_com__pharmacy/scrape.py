...
website = "martinsfoods.com/pharmacy"
...
class _SearchIteration(SearchIteration):
    ...
    def do(
        ...
        headers = {
            ...
            "origin": "https://martinsweb.rxtouch.com",
            "sec-fetch-site": "same-site",
            "sec-fetch-mode": "cors",
            "sec-fetch-dest": "empty",
            "referer": "https://martinsweb.rxtouch.com/",
        ...
        try:
            ...
            r = self.__http.post(
                "https://api-cs.rxtouch.com/rxwebapi/1.0.8/martins/api/Store/GetStoresByZip",
                headers=headers,
            ...
            if json_data["success"] is True:
                ...
                for data in json_data["data"]:
                    ...
                    page_url = "https://martinsfoods.com/pharmacy"
                    if "#" in location_name:
