...
def fetch_data():
    ...
    search_url = "https://buc-ees.com/wp-admin/admin-ajax.php?action=store_search&lat=30.26715&lng=-97.74306&max_results=50000&search_radius=50000&autoload=1"
    stores_req = session.get(search_url, headers=headers)
    stores = json.loads(stores_req.text)

    for store in stores:
        page_url = "https://buc-ees.com/locations/"
