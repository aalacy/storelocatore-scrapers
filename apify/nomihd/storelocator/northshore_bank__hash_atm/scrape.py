...
website = "https://northshore.bank/#atm"
...
def fetch_data():
    # Your scraper here
    api_url = "https://northshore.bank/_/api/atms/46.7853647/-92.1009078/50"
    api_res = session.get(api_url, headers=headers)

    json_res = json.loads(api_res.text)

    stores_list = json_res["atms"]

    for store in stores_list:
        if store["networkName"] != "Our ATMs":
            continue
