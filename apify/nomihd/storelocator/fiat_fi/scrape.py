...
class _SearchIteration(SearchIteration):
    ...
    def do(
        ...
        search_url = "https://www.fiat.{}/wp-content/themes/fca-themes-fiat/js/json/stores.php?lat={}&lng={}&current_language_code={}&distance=100"
        current_language_code = (
            self.__country_dict[current_country].split(":")[0].strip()
        )
        domain_part = self.__country_dict[current_country].split(":")[-1].strip()

        if domain_part == "-official.tn":
            search_url = "https://www.fiat-official.tn/wp-content/themes/fca-themes-fiat/js/json/stores.php?lat={}&lng={}&current_language_code={}&distance=100"
            final_url = search_url.format(lat, lng, current_language_code)
        else:
