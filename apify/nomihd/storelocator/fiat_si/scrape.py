...
def fetch_data():
    # Your scraper here
    search_url = "https://www.fiat.si/prodajno-servisna-mreza/"
    api_url = "https://avtotriglav.specto.si/map-fiat/"
    ...
    with SgRequests() as session:
        ...
        for section in sections:
            location_type = "".join(section.xpath("data-group")).strip()
            ...
            for store in stores:
                ...
                if "Telefon:" in data:
                    ...
                    phone = data.split("Telefon:")[1].split("E-naslov:")[0].strip()
                    hours_of_operation = (
