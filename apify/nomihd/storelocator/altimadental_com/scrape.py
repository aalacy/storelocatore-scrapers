...
def fetch_data():
    # Your scraper here
    base = "https://www.altimadental.com"
    api_url = "https://www.altimadental.com/wp-admin/admin-ajax.php?action=asl_load_stores&nonce=dd24822499&load_all=1&layout=1"
