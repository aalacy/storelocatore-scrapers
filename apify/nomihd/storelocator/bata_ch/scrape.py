...
headers = {
    ...
    "Referer": "https://www.bata.ch/stores",
    ...
    with SgRequests() as session:
        while True:
            ...
            stores_req = session.get(
                "https://www.bata.ch/store-locator-stores",
                params=params,
                headers=headers,
            )
            ...
            for store in stores:
                ...
                for key in props.keys():
                    if props[key]["de_CH.UTF-8"]["description"] == "Telefonnummer":
                        phone = props[key]["de_CH.UTF-8"]["value"]

                    if props[key]["de_CH.UTF-8"]["description"] == "Öffnungszeiten":
                        hours_of_operation = props[key]["de_CH.UTF-8"]["value"]
