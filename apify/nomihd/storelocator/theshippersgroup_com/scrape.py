...
website = "theshippersgroup.com"
log = sglog.SgLogSetup().get_logger(logger_name=website)
session = SgRequests()
headers = {
    "authority": "www.theshippersgroup.com",
...
def fetch_data():
    # Your scraper here
    base = "https://www.theshippersgroup.com"
    search_url = "https://www.theshippersgroup.com/all-locations"
    search_res = session.get(search_url, headers=headers)

    search_sel = lxml.html.fromstring(search_res.text)

    store_list = search_sel.xpath('//li[@class="link"]')
    ...
    for store in store_list:
        ...
        store_info = (
            "".join(store.xpath('.//div[@class="link-description"]/text()'))
            .strip()
            .split("\n")
        )
