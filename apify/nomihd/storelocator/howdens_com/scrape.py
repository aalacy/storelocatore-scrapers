...
headers = {
    ...
    "accept": "*/*",
    "origin": "https://www.howdens.com",
    "sec-fetch-site": "cross-site",
    "sec-fetch-mode": "cors",
    "sec-fetch-dest": "empty",
    "referer": "https://www.howdens.com/",
...
class _SearchIteration(SearchIteration):
    ...
    def __init__(self, http: SgRequests, country: str):
        ...
        session = SgRequests()
        search_url = "https://www.howdens.com/"
        stores_req = session.get(search_url)
        self.__API_KEY = (
            stores_req.text.split(".js?key=")[1].strip().split('"')[0].strip()
        )
    ...
    def do(
        ...
        for store in stores:
            ...
            page_url = "https://www.howdens.com/"
            yield SgRecord(
...
def scrape():
    ...
    with SgWriter(
        ...
        with SgRequests(dont_retry_status_codes=([404])) as http:
            search_iter = _SearchIteration(http=http, country="GB")
