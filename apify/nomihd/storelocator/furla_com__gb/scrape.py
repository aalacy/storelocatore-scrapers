...
headers = {
    ...
    "referer": "https://www.furla.com/gb/en/eshop/stores",
...
def fetch_data():
    ...
    search_url = "https://www.furla.com/on/demandware.store/Sites-furla-emea-Site/en_GB/Stores-GetStores"
    data = '{"center":{"lat":55.15947676434527,"lng":-4.4737716000000205},"distance":99999,"filters":{},"types":["country","political"],"address_components":[{"long_name":"United Kingdom","short_name":"GB","types":["country","political"]}]}'
    ...
    for store in stores:
        ...
        page_url = (
            "https://www.furla.com/gb/en/eshop/storedetails?StoreID=" + store_number
        )
