...
website = "madmex.co.nz"
log = sglog.SgLogSetup().get_logger(logger_name=website)
headers = {
    "authority": "madmex.co.nz",
    ...
    "referer": "https://madmex.co.nz/locations/",
...
def fetch_data():
    # Your scraper here
    api_url = (
        "https://madmex.co.nz/wp-content/plugins/superstorefinder-wp/ssf-wp-xml.php"
    )
    with SgRequests() as session:
        ...
        for store in stores:
            ...
            page_url = "https://madmex.co.nz/location/" + location_name
