...
def fetch_data():
    # Your scraper here
    search_url = "https://www.smythstoys.com/at/de-at/store-finder/getAllStores"
    with SgRequests(dont_retry_status_codes=([404])) as session:
        session.get("https://www.smythstoys.com/at/de-at/", headers=headers)
