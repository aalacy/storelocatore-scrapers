...
website = "securitynb.com"
log = sglog.SgLogSetup().get_logger(logger_name=website)
session = SgRequests()
headers = {
    "authority": "www.securitynb.com",
...
def fetch_data():
    # Your scraper here
    search_url = "https://www.securitynb.com/about-us/locations-hours.html"
    stores_req = session.get(search_url, headers=headers)
    stores_sel = lxml.html.fromstring(stores_req.text)
    stores = stores_sel.xpath('//ul[@id="locList"]')[0].xpath('li[@class="loc"]')
    for store in stores:
        page_url = (
            "https://www.securitynb.com"
