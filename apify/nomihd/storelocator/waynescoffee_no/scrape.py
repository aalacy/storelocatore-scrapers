...
website = "waynescoffee.no"
log = sglog.SgLogSetup().get_logger(logger_name=website)
headers = {
    "authority": "www.waynescoffee.no",
    ...
    "referer": "https://www.waynescoffee.no/kafeer/",
...
def fetch_data():
    # Your scraper here
    search_url = "https://www.waynescoffee.no/kafeer/"
        ...
        for store_url in stores:
            ...
            raw_address = list(
                filter(
                    str,
                    store_sel.xpath(
                        '//div[@class="single-cafe__content"][./p/strong[contains(text(),"besøksadresse")]]/p/text()'
                    ),
                )
            )
            ...
            hours_req = session.get(
                f"https://www.waynescoffee.no/theme/ajax.php?action=cafe_opening&storeid={store_number}",
                headers=headers,
            )
