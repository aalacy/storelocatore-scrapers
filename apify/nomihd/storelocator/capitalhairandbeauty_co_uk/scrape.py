...
website = "capitalhairandbeauty.co.uk"
log = sglog.SgLogSetup().get_logger(logger_name=website)
session = SgRequests()
headers = {
    "authority": "www.capitalhairandbeauty.co.uk",
...
def fetch_data():
    # Your scraper here
    base = "https://www.capitalhairandbeauty.co.uk"
    search_url = "https://www.capitalhairandbeauty.co.uk/stores?view_all=true"
