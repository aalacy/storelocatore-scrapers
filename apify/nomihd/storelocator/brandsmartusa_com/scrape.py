        ...
        for store_slug in stores:
            ...
            for section in sections:
                ...
                store_sel = lxml.html.fromstring(
                    current_section["htmlContent"]["content"]
                )
                ...
                if len(latitude) <= 0:
                    ...
                    if len(map_link) > 0:
                        latitude = (
                            map_link.split("!3d")[1].strip().split("!")[0].strip()
                        )
                        longitude = (
                            map_link.split("!2d")[1].strip().split("!")[0].strip()
                        )
                ...
                if len(street_address) <= 0:
                    ...
                    if len(street_address) <= 0:
                        ...
                        if len(address) > 0:
                            ...
                            phone = (
                                add_list[-1].strip().replace("Call or Text", "").strip()
                            )
                    else:
                        city = "".join(
                            store_sel.xpath(
            ...
            if (
                page_url
                == "https://www.brandsmartusa.com/store/fl/davie/4815-s-state-rd-7"
            ):
