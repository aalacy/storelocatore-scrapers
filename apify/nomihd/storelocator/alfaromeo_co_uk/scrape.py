...
class _SearchIteration(SearchIteration):
    ...
    def do(
        ...
        search_url = "https://dealerlocator.fiat.com/geocall/RestServlet?jsonp=callback&mkt={}&brand=83&func=finddealerxml&serv=sales&track=1&x={}&y={}&rad=100"
