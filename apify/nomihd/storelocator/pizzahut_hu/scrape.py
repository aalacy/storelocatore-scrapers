...
AUTH_HEADERS = {
    ...
    "Brand": "PH",
    "Source": "WEB",
    "Origin": "https://pizzahut.hu",
    "Sec-Fetch-Site": "cross-site",
    "Sec-Fetch-Mode": "cors",
    "Sec-Fetch-Dest": "empty",
    "Referer": "https://pizzahut.hu/",
}
...
def fetch_data():
    ...
    auth_req = session.post(
        "https://kfcfutar.hu/ordering-api/rest/v1/auth/get-token",
    ...
    stores_req = session.get(
        "https://kfcfutar.hu/ordering-api/rest/v2/restaurants/", headers=headers
    )
    ...
    for store in stores:
        ...
        store_req = session.get(
            f"https://kfcfutar.hu/ordering-api/rest/v1/restaurants/{str(store['id'])}/TAKEAWAY",
            headers=headers,
        )
        ...
        page_url = f"https://pizzahut.hu/en/restaurants/{str(store_number)}-{store_json['storeLocatorUrl']}"
