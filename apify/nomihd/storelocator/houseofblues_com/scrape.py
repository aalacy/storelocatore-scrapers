...
domain = "https://locations.houseofblues.com/"
...
def get_store_data(store_sel, page_url):
    ...
    location_name = " ".join(
        store_sel.xpath('//h1/span[@class="LocationName"]/span//text()')
    ).strip()
    street_address = "".join(
        store_sel.xpath(
    ...
    country_code = store_sel.xpath('//abbr[@itemprop="addressCountry"]/text()')
...
def fetch_data():
    # Your scraper here
    states_sel = get_selector("https://locations.houseofblues.com/restaurant-and-bar")
