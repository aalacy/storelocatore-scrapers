...
website = "fieldandtrek.com"
log = sglog.SgLogSetup().get_logger(logger_name=website)
headers = {
    "authority": "www.fieldandtrek.com",
...
def fetch_data():
    # Your scraper here
    search_url = "https://www.fieldandtrek.com/stores/all"
        ...
        for store in stores:
            ...
            if store_req:
                ...
                if "var store =" in store_req.text:
                    ...
                    if len(hours) <= 0:
                        hours = store_sel.xpath(
                            '//div[@id="StoreDetailsContainer"]//div[./meta[@itemprop="openingHours"]]/span/text()'
                        )
                    hours_list = []
                    for hour in hours:
