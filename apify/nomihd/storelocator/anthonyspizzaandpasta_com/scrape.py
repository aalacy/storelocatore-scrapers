...
website = "anthonyspizzaandpasta.com"
...
def fetch_data():
    ...
    search_url = "https://www.anthonyspizzaandpasta.com/locations"
    ...
    for store in stores:
        page_url = "https://www.anthonyspizzaandpasta.com" + store["details"]
        ...
        street_address = temp_address.split(",")[0].strip().replace(city, "").strip()

        state = temp_address.split(",")[-1].strip().split(" ")[0].strip()
