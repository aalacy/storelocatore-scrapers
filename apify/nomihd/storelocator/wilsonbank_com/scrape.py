...
def fetch_data():
    ...
    stores = stores_sel.xpath(
        '//div[@class="card-body row"]//a[contains(text(),"See Location Details")]/@href'
    )
    for store_url in stores:

        page_url = "https://www.wilsonbank.com" + store_url
        log.info(page_url)
        ...
        raw_info = store_sel.xpath('//table[@class="table"]/tbody/tr[1]/td[1]//text()')
        add_list = []
        phone = ""
        for r in raw_info:
