...
def fetch_data():
    ...
    for store_url in stores:
        ...
        address = "".join(
            store_sel.xpath('//div[@class="fusion-text fusion-text-2"]/h4[1]//text()')
        ).strip()
        phone = "".join(
            store_sel.xpath('//div[@class="fusion-text fusion-text-2"]//h4[2]//text()')
        ).strip()
        ...
        hours_of_operation = (
            "; ".join(
                store_sel.xpath('//div[@class="fusion-text fusion-text-3"]/h4/text()')
            )
