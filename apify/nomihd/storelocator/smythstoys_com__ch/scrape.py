...
def fetch_data():
    # Your scraper here
    search_url = "https://www.smythstoys.com/ch/de-ch/store-finder/getAllStores"
    with SgRequests() as session:
        session.get("https://www.smythstoys.com/ch/de-ch/", headers=headers)
