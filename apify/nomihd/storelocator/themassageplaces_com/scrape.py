...
website = "themassageplaces.com"
log = sglog.SgLogSetup().get_logger(logger_name=website)
session = SgRequests()
headers = {
    "authority": "www.themassageplaces.com",
...
def fetch_data():
    # Your scraper here
    search_url = "https://www.themassageplaces.com/hours-location/"
    search_res = session.get(search_url, headers=headers)

    search_sel = lxml.html.fromstring(search_res.text)

    store_list = list(search_sel.xpath('//*[contains(@class,"location_")]'))
    ...
    for store in store_list:
        ...
        raw_address = " ".join(full_address).split("(")[0]
