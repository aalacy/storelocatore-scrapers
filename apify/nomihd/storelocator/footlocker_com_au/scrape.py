...
website = "footlocker.com.au"
domain = "https://stores.footlocker.com.au/"
...
def fetch_data(session):
    ...
    states_sel = get_selector("https://stores.footlocker.com.au/index.html", session)
