...
website = "britishbeer.com"
log = sglog.SgLogSetup().get_logger(logger_name=website)
session = SgRequests()
headers = {
    "authority": "www.britishbeer.com",
    "sec-ch-ua": '"Chromium";v="88", "Google Chrome";v="88", ";Not A Brand";v="99"',
    "accept": "*/*",
    "sec-ch-ua-mobile": "?0",
    "user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.190 Safari/537.36",
    "content-type": "application/json",
    "origin": "https://www.britishbeer.com",
    "sec-fetch-site": "same-origin",
    "sec-fetch-mode": "cors",
    "sec-fetch-dest": "empty",
    "referer": "https://www.britishbeer.com/find-your-local",
...
def fetch_data():
    ...
    data = '{"operationName":"restaurantWithLocations","variables":{"restaurantId":3850},"extensions":{"operationId":"PopmenuClient/1314972022f7e2b12673700232e6be54"}}'
