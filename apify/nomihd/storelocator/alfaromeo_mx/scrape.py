                        ...
                        filter(
                            ...
                            [
                                ...
                                for x in store_sel.xpath(
                                    '//h4[contains(text(),"Horario de Ventas")]/../ul/li//text()'
                                )
                            ],
                        )
                    )
