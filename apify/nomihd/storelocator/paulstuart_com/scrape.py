...
def fetch_data():
    # Your scraper here
    search_url = "https://www.paulstuart.com/our-stores.html"
            ...
            filter(
                ...
                [
                    ...
                    for x in store.xpath(
                        './/p[.//text() and count(preceding-sibling::h3)=0 and not(contains(.//@href,"tel")) and not(./span)]//text()'
                    )
                ],
            )
        )
        ...
        hours = list(
            filter(
                ...
                [
                    x.strip()
                    for x in store.xpath(
                        './/p[.//text() and count(preceding-sibling::h3)=1 and not(contains(.//@href,"tel")) ]//text()'
                    )
                ],
            )
        )
