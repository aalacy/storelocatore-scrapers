...
def fetch_data():
    # Your scraper here
    search_url = "https://williamsfreshcafe.com/wp-admin/admin-ajax.php?action=store_search&lat=43.65323&lng=-79.38318&max_results=25&search_radius=200"
    stores_req = session.get(search_url, headers=headers)
    stores = json.loads(stores_req.text)

    for store in stores:
        page_url = "https://williamsfreshcafe.com/locations/"
