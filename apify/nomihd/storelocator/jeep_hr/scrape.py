...
def fetch_data():
    # Your scraper here
    search_urls = [
        "https://www.jeep.hr/prodajno-servisna-mreza/",
        "https://www.jeep.si/prodajno-servisna-mreza/",
    ]
    api_urls = [
        "https://avtotriglav.specto.si/hr/map-jeep-hr/",
        "https://avtotriglav.specto.si/map-jeep/",
    ]
    ...
    with SgRequests() as session:
        for index in range(0, len(api_urls)):
            ...
            for store in stores:
                ...
                country_code = page_url.split("jeep.")[1].strip().split("/")[0].strip()
