...
headers = {
    ...
    "referer": "https://www.willys.se/butik-sok",
...
def fetch_data():
    ...
    with SgRequests() as session:
        stores_req = session.get(
            "https://www.willys.se/axfood/rest/store", headers=headers, params=params
        )
        stores = json.loads(stores_req.text)
        for store in stores:

            store_number = store["storeId"]
            page_url = f"https://www.willys.se/butik/{store_number}"
