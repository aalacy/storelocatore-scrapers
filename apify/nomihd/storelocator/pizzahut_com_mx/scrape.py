...
headers = {
    ...
    "client": "e73194ae-309e-4f8e-81d7-ef95c3179d20",
    "origin": "https://pizzahut.com.mx",
    "sec-fetch-site": "cross-site",
    "sec-fetch-mode": "cors",
    "sec-fetch-dest": "empty",
    "referer": "https://pizzahut.com.mx/",
...
def fetch_records_for(coords):
    ...
    search_url = "https://apisae1.phdvasia.com/v1/product-hut-fe/localizations"
    params = (
        ("location", f"{lng},{lat}"),
        ("order_type", "C"),
        ("limit", "1000"),
...
def process_record(raw_results_from_one_coordinate):
    ...
    for store in stores:
        ...
        hours_of_operation = store["opening_hours"]
        latitude = store["lat"]
...
def scrape():
    ...
    with SgWriter(
        ...
        search = DynamicGeoSearch(country_codes=["MX"])
        results = parallelize(
