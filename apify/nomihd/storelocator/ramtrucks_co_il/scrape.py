...
website = "ramtrucks.co.il"
log = sglog.SgLogSetup().get_logger(logger_name=website)
headers = {
    "authority": "www.ramtrucks.co.il",
...
class _SearchIteration(SearchIteration):
    ...
    def do(
        ...
        search_url = "https://www.ram{}/wp-content/themes/fca-themes-fiat/js/json/stores.php?lat={}&lng={}&current_language_code={}&distance=100"
