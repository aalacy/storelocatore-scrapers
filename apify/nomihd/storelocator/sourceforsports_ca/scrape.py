...
session = SgRequests()
headers = {
    "authority": "www.sourceforsports.ca",
    ...
    "referer": "https://www.sourceforsports.ca/pages/stores",
...
def fetch_data():
    # Your scraper here
    search_url = "https://www.sourceforsports.ca/apps/api/stores"
    ...
    for lat, lng in search:
        ...
        for store in stores:
            ...
            page_url = (
                "https://www.sourceforsports.ca/pages/" + store["landing_page_url"]
            )
