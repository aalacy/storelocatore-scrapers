...
website = "alfaromeo.co.ma"
log = sglog.SgLogSetup().get_logger(logger_name=website)
headers = {
    "authority": "www.alfaromeo.co.ma",
...
def fetch_data():
    # Your scraper here
    search_url = "https://www.alfaromeo.co.ma/distributeur-alfa-romeo"

    with SgRequests() as session:
        search_res = session.get(search_url, headers=headers)

        search_sel = lxml.html.fromstring(
            search_res.text.split("<h1>Distributeurs")[0].strip()
        )
