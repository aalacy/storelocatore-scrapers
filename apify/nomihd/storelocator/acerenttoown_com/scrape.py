...
def fetch_data():
    ...
    stores = stores_sel.xpath('//div[@class="view-details"]/a/@href')
    for store_url in stores:
        page_url = "https://www.acerenttoown.com" + store_url
        log.info(page_url)
        ...
        hours = store_sel.xpath(
            '//div[@class="location-row padding-left hours"]//div[@class="table"]/div[@class="tr"]'
        )
        for hour in hours:
