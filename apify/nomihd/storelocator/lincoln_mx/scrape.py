...
def fetch_data():
    ...
    search_url = "https://spatial.virtualearth.net/REST/v1/data/1652026ff3b247cd9d1f4cc12b9a080b/FordEuropeDealers_Transition/Dealer?$select=*,__Distance&$filter=Brand%20Eq%20%27Lincoln%27&$top=0&$inlinecount=allpages&$format=json&key=Al1EdZ_aW5T6XNlr-BJxCw1l4KaA0tmXFI_eTl1RITyYptWUS0qit_MprtcG7w2F&$skip={}"
    skip_index = 0
