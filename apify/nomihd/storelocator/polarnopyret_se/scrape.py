...
website = "polarnopyret.se"
log = sglog.SgLogSetup().get_logger(logger_name=website)

headers = {
    "authority": "www.polarnopyret.se",
    ...
    "referer": "https://www.polarnopyret.se/butiker?ssr=on&loadfailure=1",
...
def fetch_data():
    ...
    with SgRequests(dont_retry_status_codes=([404])) as session:
        stores_req = session.get(
            "https://www.polarnopyret.se/butiker", headers=headers, params=params
        )
        stores = stores_req.json()["stores"]
        for store in stores:
            page_url = "https://www.polarnopyret.se/butiker?ssr=on&loadfailure=1"
