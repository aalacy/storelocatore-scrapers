...
def fetch_data():
    ...
    search_url = "https://www.piccadilly.com/locations/"
    ...
    for store in stores:
        page_url = "https://www.piccadilly.com/locations/" + store["permalink"]
        ...
        if len(hours) > 0:
            ...
            for day in hour.keys():
                if day != "label":
                    hour_list.append(day + ":" + hour[day])
