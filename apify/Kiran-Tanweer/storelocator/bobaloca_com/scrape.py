    ...
    for link in links:
        if link.find('http://www.bobaloca.com/') != -1:
            ...
            if len(table) > 23:
                ...
                phone = table[14].text
                hours = table[9].text + ' ' + table[10].text + ' ' + table[12].text + ' ' + table[13].text + ' ' + table[15].text + ' ' + table[16].text + ' ' + table[18].text

            else:
                if link == 'http://www.bobaloca.com/category_s/1850.htm':
                    address = table[6].text
                    phone = table[9].text
                    hours = table[4].text + ' ' + table[5].text + ' ' + table[7].text + ' ' + table[8].text + ' ' + table[10].text + ' ' + table[11].text + ' ' + table[13].text
                ...
                if link == 'http://www.bobaloca.com/Boba_Loca_Gilroy_s/1857.htm':
                    ...
                    phone = table[13].text
                    hours = table[8].text + ' ' + table[9].text + ' ' + table[11].text + ' ' + table[12].text + ' ' + table[14].text + ' ' + table[15].text + ' ' + table[17].text

                if link == 'http://www.bobaloca.com/Montrose_Boba_Loca_s/1852.htm':
                    address = table[6].text + ' ' + table[9].text
                    phone = table[12].text
                    hours = table[7].text + ' ' + table[8].text + ' ' + table[10].text + ' ' + table[11].text + ' ' + table[13].text + ' ' + table[14].text + ' ' + table[16].text

                if link == 'http://www.bobaloca.com/North_Hollywood_Boba_Loca_s/1830.htm':
                    address = table[8].text + ' ' + table[11].text
                    phone = table[14].text
                    hours = table[9].text + ' ' + table[10].text + ' ' + table[12].text + ' ' + table[13].text + ' ' + table[15].text + ' ' + table[16].text + ' ' + table[18].text
                ...
                if link == 'http://www.bobaloca.com/WOODLAND_HILLS_BOBA_LOCA_s/1853.htm':
                    address = table[8].text + ' ' + table[11].text
                    phone = table[14].text
                    hours = table[9].text + ' ' + table[10].text + ' ' + table[12].text + ' ' + table[13].text + ' ' + table[15].text + ' ' + table[16].text + ' ' + table[18].text
