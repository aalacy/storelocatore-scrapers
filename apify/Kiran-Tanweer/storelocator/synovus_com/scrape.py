...
def fetch_data():
    ...
    for state in state_list:
        url = 'https://www.mapquestapi.com/search/v2/radius?origin=' + state + '&radius=100&distanceUnit=dm&hostedData=mqap.36969_Synovus&ambiguities=ignore&key=Gmjtd%7Cluu7n961n1%2Crw%3Do5-ly10h&callback=window.MapManager.processSearchResults&_=1606874485792'
...
# Wheeler Road Office and ATM
# Washington Road Branch and ATM
# python validate.py data.csv --ignore LatLngDuplicationValidator --ignore StreetAddressHasNumber