...
def fetch_data():
    ...
    for i in range(1,3):
        ...
        for locs in div:
            loc = locs.findAll("div", {"class":"accordion-group panel rl_sliders-group nn_sliders-group"})
            for l in loc:
                title = l.find('span', {'class':'rl_sliders-toggle-inner nn_sliders-toggle-inner'}).text
                ...
                if address != '4300 Alton Road Ascher Building Miami Beach FL 33140':
                    ...
                    hours = hours.lstrip('**Share Branching will remain Drive-Thru only** ')
                    hours = hours.lstrip('Lobby Hours ')
