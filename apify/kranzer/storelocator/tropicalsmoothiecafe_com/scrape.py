...
base_url = "https://locations.tropicalsmoothiecafe.com/index.html"
...
class Scrape(base.Spider):
    ...
    async def _fetch_store(self, session, url):
        async with session.get(url, timeout=60 * 60) as response:
            ...
            i.add_xpath('location_name', '//div[@class="Hero-core"]//text()', lambda x: ' - '.join(x),
                        lambda x: x.strip())
            i.add_xpath('phone', '//div[@class="NAP-phone"]//a[contains(@class, "c-phone-number-link")]/text()',
            ...
            i.add_xpath('street_address',
                        '//div[@class="NAP-address"]//address[@class="c-address"]//span[@class="c-address-street-1" or @class="c-address-street-2"]/text()',
            ...
            i.add_xpath('hours_of_operation',
                        '//table[@class="c-location-hours-details"]//tr[@itemprop="openingHours"]/@content',
