...
def selector(url='', headers=None, verify=True):
    if url:
        headers = headers or {}
    ...
    def write_output(self, data):
        if data:
            with open('data.csv', mode='w') as output_file:
                fields = ["page_url", "locator_domain", "location_name", "street_address", "city", "state", "zip", "country_code", "store_number", "phone", "location_type", "latitude", "longitude", "hours_of_operation"]
