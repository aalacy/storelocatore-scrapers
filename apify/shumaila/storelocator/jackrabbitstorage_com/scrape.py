...
def fetch_data():
    ...
    url = "https://www.jackrabbitstorage.com/sitemaps/index-by-state-VA.xml"
    ...
    for link in linklist:
        ...
        yield SgRecord(
            locator_domain="https://www.jackrabbitstorage.com/",
            page_url=link,
            location_name=title,
            ...
            latitude=str(lat),
            longitude=str(longt),
            hours_of_operation=hours.replace(":00 am", " am").replace(":00 pm", " pm"),
        )
