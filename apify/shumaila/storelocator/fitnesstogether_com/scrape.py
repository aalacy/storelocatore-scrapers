...
def fetch_data():
    ...
    divlist = soup.select("a[href*=find-a-]")    
    hourdict = {1:'mon',2:'tue',3:'wed',4:'thu',5:'fri',6:'sat',7:'sun'}
    for div in divlist:
        search = div.text
        gurl = 'https://maps.googleapis.com/maps/api/geocode/json?address='+search+'&key=AIzaSyCT4uvUVAv4U6-Lgeg94CIuxUg-iM2aA4s&components=country%3AUS'
        ...
        if r['status'] == 'REQUEST_DENIED':
            ...
            latnow = coord['lat']
            lngnow = coord['lng']
        url = 'https://fitnesstogether.com/locator?q='+search+'%2C%20United%20States&lat='+str(latnow)+'&lng='+str(lngnow)
        ...
        for loc in loclist:
            ...
            for hr in hourslist:
                ...
                hours = hours + day + ' '+start + ' AM - '+str(endtime) + ':'+end[1]+' PM '
