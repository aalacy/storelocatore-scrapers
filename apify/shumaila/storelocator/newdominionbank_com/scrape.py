...
logger = SgLogSetup().get_logger('newdominionbank_com')
...
def fetch_data():
    ...
    url = 'https://newdominionbank.com/locations/?place&latitude&longitude&type=location#038;latitude&longitude&type=location'
    flag = True
    while flag:
        #logger.info(url)
