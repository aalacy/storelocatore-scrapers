...
def fetch_data():
    ...
    for loc in s:
        ...
        if loc["SmallTimes"]:
            weekday =  loc["SmallTimes"][0]['DayOfWeek'] +": "+ loc["SmallTimes"][0]['OpeningAt'] +" - "+ loc["SmallTimes"][0]['ClosingAt'] 
            sat = loc["SmallTimes"][1]['DayOfWeek'] + ": "+ loc["SmallTimes"][1]['OpeningAt'] +" - "+ loc["SmallTimes"][1]['ClosingAt'] 
            sun = loc["SmallTimes"][2]['DayOfWeek'] + ": "+ loc["SmallTimes"][2]['OpeningAt'] +" - "+ loc["SmallTimes"][2]['ClosingAt']
