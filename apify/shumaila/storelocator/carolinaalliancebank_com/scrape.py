...
logger = SgLogSetup().get_logger('carolinaalliancebank_com')
...
def fetch_data():
    ...
    #url = 'https://carolinaalliancebank.com/locations/?place&latitude&longitude&type=location#038;latitude&longitude&type=location'
    url = 'https://carolinaalliancebank.com/locations/?place=&latitude=&longitude=&type=location&parent_bank%5B%5D=carolina-alliance-bank'
    flag = True
    while flag:
        #logger.info(url)
        ...
        for div in divlist:
            ...
            data.append([
                'https://carolinaalliancebank.com/',
                url,
                title,
                street,
                city,
