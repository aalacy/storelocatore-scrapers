...
def para(tup):
    ...
    k["index"] = tup[0]
    k["requrl"] = "https://www.thegreatsteak.com/stores/" + str(tup[1])
    session = SgRequests()
...
def fetch_data():
    ...
    url = "https://locator.kahalamgmt.com/locator/index.php?brand=8&mode=map&latitude=&longitude=&q=&pagesize=0"
    headers = {
...
def scrape():
    url = "https://www.thegreatsteak.com/"
