...
'Cookie': str(''.join([#'CONSENTMGR=consent:true;',
    ...
    coords = sgzip.coords_for_radius(radius=99, country_code=SearchableCountries.CANADA)
    ...
    j = utils.parallelize(
                ...
                fetch_results_for_rec = lambda x : net_utils.fetch_xml(
                                                    ...
                                                    request_url="https://www.pearlevision.ca/webapp/wcs/stores/servlet/AjaxStoreLocatorResultsView?resultSize=5000&latitude="+x[0]+"&longitude="+x[1],
                                                    headers=headers),
                max_threads = 15,
...
def scrape():
    ...
    field_defs = SimpleScraperPipeline.field_definitions(
        ...
        country_code=ConstantField("CA"),#MappingField(mapping=[], ),
    ...
    pipeline = SimpleScraperPipeline(scraper_name='pearlevision.ca',
