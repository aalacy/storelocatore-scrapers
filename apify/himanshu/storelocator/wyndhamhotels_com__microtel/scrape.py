...
def fetch_data():
    ...
    a = soup.find("div",{"class":"aem-rendered-content"}).find_all("div",{"class":"state-container"})[0:43]
    for y in a:
        ...
        for b in e:
            ...
            if b != [] and b != None:
                ...
                yield store
    a1 = soup.find("div",{"class":"aem-rendered-content"}).find_all("div",{"class":"state-container"})[43:49]
    for y1 in a1:
