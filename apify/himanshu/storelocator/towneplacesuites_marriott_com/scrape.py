...
base_url = 'https://towneplacesuites.marriott.com/'
...
def fetch_data():
    output_list = []
    url = "https://pacsys.marriott.com/data/marriott_properties_TS_en-US.json"
                ...
                for h in k['state_cities']:
                    for g in (h['city_properties']):
                        if "USA" in (g['country_name']):
                            ...
                            output.append("TownePlace Suites Hotel") #location type
