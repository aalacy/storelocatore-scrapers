    ...
    for z in zips:
        ...
        try:
            ...
            r = requests.get("https://www.mapquestapi.com/search/v2/radius?callback=jQuery22408729727990432037_1568814338463&key=Gmjtd%7Clu6t2luan5%252C72%253Do5-larsq&origin="+str(z)+"" \
                           "&units=m&maxMatches=1000&radius=100&hostedData=mqap.33454_DunkinDonuts&ambiguities=ignore&_=1568814338464")
            ...
            for x in data_json['searchResults']:
                ...
                hours_of_operation = ' mon '+ vj['mon_hours'] + '  tue' + vj['tue_hours'] + ' wed '+ vj['wed_hours'] + ' thu ' + vj['thu_hours'] + ' fri ' + vj['fri_hours'] + ' sat ' + vj['sat_hours'] + ' sun ' + vj['sun_hours']
