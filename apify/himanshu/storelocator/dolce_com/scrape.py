...
def fetch_data():
    ...
    location_url1 = "https://www.wyndhamhotels.com/dolce/locations"
    try:
        r = session.get(location_url1, headers=headers,  allow_redirects=False)
    except Exception as e :
        pass
    soup= BeautifulSoup(r.text,"lxml")
    a = soup.find("div",{"class":"aem-rendered-content"}).find_all("div",{"class":"state-container"})[0:6]
    for y in a:
        ...
        for b in e:
            ...
            if b != [] :
                ...
                store.append("Wyndham dolce hotel")
