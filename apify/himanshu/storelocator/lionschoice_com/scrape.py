...
def fetch_data():
    ...
    r = requests.get("https://lionschoice.com/wp-admin/admin-ajax.php?action=store_search&lat=38.64466&lng=-90.33013&max_results=25&search_radius=10&autoload=1", headers=headers).json()
