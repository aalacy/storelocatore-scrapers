...
def fetch_locations():
    data = session.get(
        "https://maps.restaurants.applebees.com/api/getAsyncLocations?template=domain&level=domain&lat=35.884558999999996&lng=-78.6117549&radius=10000&limit=10000"
    ).json()
