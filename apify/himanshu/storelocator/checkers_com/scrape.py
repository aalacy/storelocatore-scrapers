    ...
    for i in k:
        ...
        if link != "1)":
            ...
            for c in citylink:
                ...
                if link1 != "1)":
                    sublink = "https://locations.checkers.com/"+c.find("a")['href']
                    ...
                    for st in store_link:
                        ...
                        page_url = "https://locations.checkers.com"+st['href'].replace("..","")
                        ...
                        name = " ".join(list(soup3.find("h1",{"class":"Nap-locationName"}).stripped_strings))
                    ...
                    one_link="https://locations.checkers.com/"+c.find("a")['href']
                    page_url = one_link
                    ...
                    name = " ".join(list(soup4.find("h1",{"class":"Nap-locationName"}).stripped_strings))
            ...
            name = " ".join(list(soup5.find("h1",{"class":"Nap-locationName"}).stripped_strings))
