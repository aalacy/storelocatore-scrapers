...
def fetch_data():
    ...
    r = requests.get("https://cache-dealersearch.audi.com/cached/audi-can.json",headers=headers)
    return_main_object = []
    ...
    for store_data in location_data:
        ...
        store.append(store_data["contactDetails"]["phone"]["display"] if store_data["contactDetails"]["phone"]["display"] != "" else "<MISSING>")
        store.append("audi")
