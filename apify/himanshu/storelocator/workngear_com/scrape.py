...
def fetch_data():
    ...
    r = requests.get("https://www.workngear.com/store-locator",headers=headers)
    soup = BeautifulSoup(r.text,"lxml")
    locations = soup.find_all("div",{"class":"results-stores"})
    return_main_object = []
    for location in soup.find_all("ul",{'class':"col-lg-4 col-sm-6 col-xs-12"}):
        ...
        hours = " ".join(list(location.find("div",{"class":'store-locator-hours'}).stripped_strings))
