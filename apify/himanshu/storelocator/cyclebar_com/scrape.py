...
def fetch_data():
    ...
    for location in json_data:
        ...
        if str(coming_soon)=="True":
            ...
            if hours != None:
                try:
                    hours1=soup.find("i",{"class":"location-info-map__icon"}).find_next('span')['data-hours']
                    ...
                    for data in json_data1:
                        ...
                        if len(json_data1[data]) == 1:
                            ...
                            hours_of_operation= hours_of_operation + ' '+ hours_of[0] + ' '+ t + ' '+  t1                         
                        else:
                            hours_of=data,json_data1[data][0][0],json_data1[data][0][1],json_data1[data][1][0],json_data1[data][1][1]
                            ...
                            hours_of_operation=hours_of_operation + ' ' +hours_of[0] + ' '+ t2 + ' '+ t3 + ' ' + t4 + ' '+ t5                  
                except:
