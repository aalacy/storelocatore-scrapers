...
logger = SgLogSetup().get_logger('kentkwik_com')
    ...
    while True:
        ...
        if json_data["address"]:
            ...
            if "Postal Code" in  json_data["columnsData"][3]['name']:
                zipp = json_data["columnsData"][3]['value']
            # if "Country" in json_data["columnsData"][4]["name"]:
            #     country_code = json_data["columnsData"][4]["value"]
