...
def fetch_data():
    ...
    for h in r:
        ...
        store.append(hours_of_operation.replace("Tuesday: 10:00 - 10:00","Tuesday: 10:00 - 22:00").replace("Tuesday: 09:00 - 09:00","Tuesday: 09:00 - 20:00").replace("Tuesday: 12:00 - 12:00","Tuesday: 12:00 - 00:00"))
