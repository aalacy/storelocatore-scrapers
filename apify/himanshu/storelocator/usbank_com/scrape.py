                                ...
                                if "" in q:
                                    for add in q[""]:
                                        ...
                                        try:
                                            ...
                                            longitude =''
                                        try:
                                            Lobby = " ".join(list(soup1.find("div",{"class":"branchLobby"}).stripped_strings))
                                        except:
                                            Lobby = ''
                                        try:
                                            Drive = " ".join(list(soup1.find("div",{"class":"branchDrive"}).stripped_strings))
                                        except:
                                            Drive =''
                                        hours_of_operation = Lobby+' ' + Drive
                                        phone = add['telephone']
                                        location_name  = add['name'].replace('and ATM','')
                                        store = []
                                        ...
                                        store.append(street_address.strip().lstrip() if street_address else '<MISSING>')
