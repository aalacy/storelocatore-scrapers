...
def fetch_data():
    ...
    return_main_object=[]
    r = requests.get('https://www.texaco.com/api/app/techron2go/ws_getChevronTexacoNearMe_r2.aspx?callback=jQuery22306785250418595727_1564653077932&lat=37.7799273&lng=-121.97801529999998&oLat=37.7799273&oLng=-121.97801529999998&brand=ChevronTexaco&radius=35&_=1564653077933',headers=headers)
