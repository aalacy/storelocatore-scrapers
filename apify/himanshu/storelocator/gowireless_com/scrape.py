...
def fetch_data():
    ...
    for loc in data['item']:
        ...
        page_url = loc['exturl']
        # hours = loc['operatingHours'].replace('<span style="color: rgb(85&#44; 85&#44; 85); font-size: 12px;">','').replace("</span>",'').replace('<span style="font-size: 11pt; font-family: Calibri&#44; sans-serif;">','').replace("<p>",'').replace("</p>",'').replace("&nbsp;",'').replace("<br>",'').strip().lstrip()
