...
def fetch_data():
    ...
    r = requests.get("https://f45training.com/find-a-studio/",headers=headers)
    ...
    for script in scripts:
        if "window.domains" in script.text:
            ...
            for i in range(len(location_list)):
                ...
                location_request = requests.get("https://f45training.com/" + current_store["slug"],headers=headers)
