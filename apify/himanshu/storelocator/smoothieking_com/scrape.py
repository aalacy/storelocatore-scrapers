...
def fetch_data():
    ...
    json_r = session.get("https://momentfeed-prod.apigee.net/api/llp.json?auth_token=TLLLFMCOPXOWXFMY&center=38.541749,-98.428791&coordinates=14.000736333337585,-64.94246287499976,56.892523132042385,-131.91511912499976&multi_account=false&page=1&pageSize=100").json()
