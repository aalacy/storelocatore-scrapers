...
def fetch_data():
    ...
    for page in range(1,54):
        json_r = session.get("https://momentfeed-prod.apigee.net/api/llp.json?auth_token=TLLLFMCOPXOWXFMY&center=38.541749,-98.428791&multi_account=false&page="+str(page)).json()
        for data in json_r:
