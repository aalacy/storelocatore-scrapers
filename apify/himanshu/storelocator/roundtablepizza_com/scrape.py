...
def fetch_data():
    ...
    r = session.get("https://ordering.roundtablepizza.com/site/rtp/locations",headers=headers)
    soup = BeautifulSoup(r.text,'lxml')

    for dt in soup.find("div",{"class":"coordinatosContainer"}).find_all("div",{"class":"coordinatos"}):
        name = dt['data-name']
