...
def fetch_data():
    ...
    if r['response'] != []:
        ...
        for val in data:
            ...
            store.append(hours_of_operation.replace("&lt;/br&gt;","") if hours_of_operation.replace("&lt;/br&gt;","") else '<MISSING>')
