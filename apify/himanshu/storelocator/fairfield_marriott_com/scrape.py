...
def fetch_data():
    ...
    base_url = "https://fairfield.marriott.com/"
    location_url = "https://fairfield.marriott.com/locations/"
    r = request_wrapper(location_url,"get",headers=headers)
    soup = BeautifulSoup(r.text,"lxml")
    data = soup.find_all("script",{"type":"text/javascript"})[5]
    mp = (data.text.split("MARRIOTT_GEO_DATA =")[1].replace('America"}}};','America"}}}'))
    ...
    for i in canada:
        ...
        for j in k:
            ...
            store.append("Fairfield Inn & Suites")
