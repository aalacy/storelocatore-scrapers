...
def fetch_data():
    ...
    r = requests.get("https://www.firstam.com/services-api/api/alta/search?take=100000&skip=0&officeDisplayFlag=true&officeZipCode=&officeStatus=active",verify=False)
    data = r.json()
    return_main_object = []
