...
def fetch_data():
    ...
    r = requests.get("https://api.zenlocator.com/v1/apps/app_txdmatvw/locations/search?northeast=77.064637%2C149.5221&southwest=-57.442352%2C-180",headers=headers)
