...
def fetch_data():
    ...
    r = requests.get("https://www.thepodhotel.com/locations.html",headers=headers)
    ...
    for location in soup.find_all("a",text=re.compile("LEARN MORE")):
        ...
        details_request = requests.get(base_url + details_url,headers=headers)
