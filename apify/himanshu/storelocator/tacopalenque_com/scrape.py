...
def fetch_data():
    ...
    r = requests.get("https://www.tacopalenque.com/wp-content/themes/tacoPalenque2017/includes/jquery-store-locator-plugin/data/locations.xml?formattedAddress=&boundsNorthEast=&boundsSouthWest=",headers=headers)
