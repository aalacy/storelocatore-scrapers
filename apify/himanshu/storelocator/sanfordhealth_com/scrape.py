...
def fetch_data():
    ...
    for anchor in jason_data['results']:
        ...
        if "printableUri" in anchor:
            page_url = anchor['printableUri']
        else:
            state = "<MISSING>"
        ...
        if "fprimaryhours46747" in anchor['raw']:
            hours ='Primary Hours'+ ' '+ anchor['raw']['fprimaryhours46747']

        if "fpharmacyhours46747" in  anchor['raw']:
            hours1 = 'Primary'+ ' '+anchor['raw']['fpharmacyhours46747']
