...
logger = SgLogSetup().get_logger('autograph-hotels_marriott_com')


session = SgRequests()

base_url = 'https://autograph-hotels.marriott.com/'
...
def fetch_data():
    output_list = []
    url = "https://pacsys.marriott.com/data/marriott_properties_AK_en-US.json"
                ...
                for h in k['state_cities']:
                    for g in (h['city_properties']):
                        if "USA" in (g['country_name']):
                            ...
                            output.append("Autograph Collection Hotel") #location type
