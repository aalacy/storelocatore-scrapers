...
base_url = "https://tribute-portfolio.marriott.com/"
...
def fetch_data():
    url = "https://pacsys.marriott.com/data/marriott_properties_TX_en-US.json"
    headers = {
                ...
                for h in k["state_cities"]:
                    for g in h["city_properties"]:
                        if "USA" in (g["country_name"]):
                            ...
                            output.append("Tribute Portfolio Hotels & Resorts")
