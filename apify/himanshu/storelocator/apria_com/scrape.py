...
logger = SgLogSetup().get_logger('apria_com')
        ...
        current_results_len = len(response['response'])
        for data in response['response']:
            ...
            store.append(str(phone).replace("Main: (803) 786-6900;  Backline: (803) 794-3934","(803) 786-6900"))
