...
def fetch_data():
    ...
    a = soup.find("div",{"class":"aem-rendered-content"}).find_all("div",{"class":"state-container"})[0:53]
    for y in a:
        ...
        for b in e:
            ...
            if b != [] and b != None:
                ...
                phone = h['telephone']              
                store = []
                store.append("https://www.wyndhamhotels.com/ramada")
                ...
                store.append("Ramada by Wyndham Hotels")
