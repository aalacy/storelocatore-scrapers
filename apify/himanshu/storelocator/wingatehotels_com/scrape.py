...
def fetch_data():
    ...
    location_url1 = "https://www.wyndhamhotels.com/wingate/locations"
    try:
        r = session.get(location_url1, headers=headers,  allow_redirects=False)
    except Exception as e :
        pass
    soup= BeautifulSoup(r.text,"lxml")
    a = soup.find("div",{"class":"aem-rendered-content"}).find_all("div",{"class":"state-container"})[0:40]
    for y in a:
        ...
        for b in e:
            ...
            if b != [] and b != None:
                ...
                phone = h['telephone']              
                store = []
                store.append("https://www.wyndhamhotels.com/wingate")
