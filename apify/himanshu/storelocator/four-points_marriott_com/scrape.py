...
logger = SgLogSetup().get_logger('four-points_marriott_com')


session = SgRequests()

base_url = 'https://four-points.marriott.com/'
...
def fetch_data():
    output_list = []
    url = "https://pacsys.marriott.com/data/marriott_properties_FP_en-US.json"
                ...
                for h in k['state_cities']:
                    for g in (h['city_properties']):
                        if "USA" in (g['country_name']):
                            ...
                            output.append("Four Points by Sheraton") #location type
