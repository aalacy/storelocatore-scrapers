...
def fetch_data(): 
    ...
    soup = requests.get("https://www.toyota.co.uk/api/dealer/drive/-0.1445783/51.502436?count=1000&extraCountries=im|gg|je&isCurrentLocation=false").json()
    for data in soup['dealers']:
        ...
        if page_url == "https://www.toyota.co.uk/dealer/Bournemouth/BH23%201EZ/Hendy%20Toyota%20(Christchurch)":
            ...
            location_soup = bs(requests.get(hour_url).text, "lxml")
