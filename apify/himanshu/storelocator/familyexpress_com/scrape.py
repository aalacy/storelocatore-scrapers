...
def fetch_data():
    ...
    r = requests.get(base_url).json()['places']
    return_main_object = []
    for location in r:
        if location['yextData']:
            store = []
            if 'isClosed' not in location['yextData']['hours']['sunday']:
                hours=" sunday : "+location['yextData']['hours']['sunday']['openIntervals'][0]['start']+"-"+location['yextData']['hours']['sunday']['openIntervals'][0]['end']
            else:
                hours=" sunday : Closed"
            if 'isClosed' not in location['yextData']['hours']['monday']:
                hours+=" monday : "+location['yextData']['hours']['monday']['openIntervals'][0]['start']+"-"+location['yextData']['hours']['monday']['openIntervals'][0]['end']
            else:
                hours+=" monday : Closed"
            if 'isClosed' not in location['yextData']['hours']['monday']:
                hours+=" monday : "+location['yextData']['hours']['monday']['openIntervals'][0]['start']+"-"+location['yextData']['hours']['monday']['openIntervals'][0]['end']
            ...
            if 'isClosed' not in location['yextData']['hours']['tuesday']:
                hours+=" tuesday : "+location['yextData']['hours']['tuesday']['openIntervals'][0]['start']+"-"+location['yextData']['hours']['tuesday']['openIntervals'][0]['end']
            else:
                hours+=" wednesday : Closed"
            if 'isClosed' not in location['yextData']['hours']['wednesday']:
                hours+=" wednesday : "+location['yextData']['hours']['wednesday']['openIntervals'][0]['start']+"-"+location['yextData']['hours']['wednesday']['openIntervals'][0]['end']
            else:
                hours+=" wednesday : Closed"
            if 'isClosed' not in location['yextData']['hours']['thursday']:
                hours+=" thursday : "+location['yextData']['hours']['thursday']['openIntervals'][0]['start']+"-"+location['yextData']['hours']['thursday']['openIntervals'][0]['end']
            else:
                hours+=" thursday : Closed"
            if 'isClosed' not in location['yextData']['hours']['friday']:
                hours+=" friday : "+location['yextData']['hours']['friday']['openIntervals'][0]['start']+"-"+location['yextData']['hours']['friday']['openIntervals'][0]['end']
            else:
                hours+=" friday : Closed"
            if 'isClosed' not in location['yextData']['hours']['saturday']:
                hours+=" saturday : "+location['yextData']['hours']['saturday']['openIntervals'][0]['start']+"-"+location['yextData']['hours']['saturday']['openIntervals'][0]['end']
            else:
