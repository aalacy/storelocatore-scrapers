            ...
            if id1 == None:
                ...
                for i in soup2:
                    ...
                    if k != None:
                        ...
                        tem_var.append(st.replace('\t',"").replace("\n","").strip() if st else "<MISSING>")
                        tem_var.append(city.lstrip().rstrip().strip() if city else "<MISSING>")
                        tem_var.append(state.strip() if state else "<MISSING>" )
                        tem_var.append(zip1.strip() if zip1 else "<MISSING>")
                        tem_var.append(contry)
                        tem_var.append("<MISSING>")
                        tem_var.append(phone.strip() if phone else "<MISSING>" )
                        tem_var.append("<MISSING>")
                        tem_var.append(lat.strip() if lat else "<MISSING>" )
                        tem_var.append(lng.strip() if lng else  "<MISSING>")
                        tem_var.append(time1.strip() if time1 else "<MISSING>")
