...
def fetch_data(sgw: SgWriter):
    ...
    payload = '{"operationName":"hotelMapZones","variables":{"brandCode":"QQ"},"query":"query hotelMapZones($brandCode: String) {\\n  hotelMapZones(brandCode: $brandCode) {\\n    id {\\n      x\\n      y\\n      __typename\\n    }\\n    bounds {\\n      southwest {\\n        latitude\\n        longitude\\n        __typename\\n      }\\n      northeast {\\n        latitude\\n        longitude\\n        __typename\\n      }\\n      __typename\\n    }\\n    countries {\\n      countryCode\\n      stateCodes\\n      __typename\\n    }\\n    brandCodes\\n    __typename\\n  }\\n}\\n"}'
    ...
    for zone in data["data"]["hotelMapZones"]:
        ...
        payload = (
            '{"operationName":"hotelSummaryOptions","variables":{"brandCodes":["QQ"],"currencyCode":"usd","language":"en","zone":{"x":'
            + str(zone["id"]["x"])
            + ',"y":'
            + str(zone["id"]["y"])
