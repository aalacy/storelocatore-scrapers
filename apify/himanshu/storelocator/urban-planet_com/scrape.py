...
def fetch_data():
    ...
    r = requests.get("https://urban-planet.com/apps/api/v1/stores?location%5Blongitude%5D=-74.0059728&location%5Blatitude%5D=40.7127753&location%5Bradius%5D=1000000&location%5Bunits%5D=km&_=1564147491195")
    data = r.json()["stores"]
    return_main_object = []
