...
logger = SgLogSetup().get_logger('chelseagroton_com')
...
def fetch_data():
    ...
    for i in link:
        ...
        if len(loc)!=35:
            ...
            tem_var.append(state_list.strip() if state_list.strip() else "<MISSING>" )
            tem_var.append(zip1.strip())
            tem_var.append("US")
            tem_var.append("<MISSING>")
            tem_var.append(phone_list.strip() if phone_list.strip() else "<MISSING>")
            ...
            for tage in strong:
                ...
                tem_var1.append(tage.text.strip().replace("&#8211;",""))
                tem_var1.append(st.strip())
                tem_var1.append(city.strip())
                tem_var1.append(state.strip() if state.strip() else "<MISSING>" )
                tem_var1.append(zip1.strip())
                tem_var1.append("US")
