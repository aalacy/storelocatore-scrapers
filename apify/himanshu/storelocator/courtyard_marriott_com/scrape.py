...
logger = SgLogSetup().get_logger('courtyard_marriott_com')
...
def fetch_data():
    output_list = []
    url = "https://pacsys.marriott.com/data/marriott_properties_CY_en-US.json"
                ...
                for h in k['state_cities']:
                    for g in (h['city_properties']):
                        if "USA" in (g['country_name']):
                            ...
                            output.append("Courtyard by Marriott") #location type
