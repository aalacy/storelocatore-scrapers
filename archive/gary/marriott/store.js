...
class Store {
  ...
  toString() {
    return `${this.locator_domain},${this.locator_name},${this.street_address},${this.city},${
      this.state
    },${this.zip},${this.country_code},${this.store_number},${this.phone},${this.location_type},${
      this.naics_code
    },${this.latitude},${this.longitude},${this.external_lat_lon},${this.hours_of_operation}`;
  }
