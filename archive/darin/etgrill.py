...
headers = {'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36',
           'cookie': 'visid_incap_1768624=aOghFF8eT8qdKtwbh+jbCLQfUl0AAAAAQUIPAAAAAACy9dA4eFVhiXJCnPz1pM/e; incap_ses_117_1768624=0DnZRQ/uogs4voaAvqufAbQfUl0AAAAAwU+q6oaQIUwuPsk2wp4Dpw==; incap_ses_115_1768624=xdMVNBJThX101Xb4sJCYAbUfUl0AAAAAE7xk/dScNOlpzynOTuQrWA==; _ga=GA1.2.1290702306.1565663159; _gid=GA1.2.1716743534.1565663159; _gat_gtag_UA_138235386_5=1'
           }
    ...
    for loc in locs:
        ...
        for line2 in loc_text.iter_lines():
            if 'Address &amp; Phone</h3><p style="text-align: center;">' in line2:
                ...
                state = fulladd.split('>')[1].split(',')[1].split(' ')[0].strip()
        ...
        yield [["etgrill.com", "El Torito Grill", add, city, state, zc, "US", "<MISSING>", phone, "Restaurant", "<MISSING>", "<MISSING>", hours]]
