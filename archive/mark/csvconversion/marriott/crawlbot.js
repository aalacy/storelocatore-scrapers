...
async function startCrawling(initialClick, secondaryClick, country, fileLocation) {
  ...
  const click2 = secondaryClick;
  const fileLocationMemory = fileLocation;
  ...
  try {
    ...
    for (let i = 1; i <= lastPage; i++) {
      ...
      for await (const obj of dataProperty) {
